...
var PrimitiveTypes = function () {
  function PrimitiveTypes(caseName, fields) {
    _classCallCheck$1(this, PrimitiveTypes);

    this.Case = caseName;
    this.Fields = fields;
  }

  _createClass$1(PrimitiveTypes, [{
...
var CommonDataRequirementsString = function () {
  function CommonDataRequirementsString(size, primitiveType, minSize) {
    _classCallCheck$1(this, CommonDataRequirementsString);
  ...
  _createClass$1(CommonDataRequirementsString, [{
    key: _Symbol.reflection,
    value: function () {
      return {
...
var CommonDataRequirementsStringPattern = function () {
  function CommonDataRequirementsStringPattern(size, primitiveType, minSize, regexPattern, charValidation) {
    _classCallCheck$1(this, CommonDataRequirementsStringPattern);
  ...
  _createClass$1(CommonDataRequirementsStringPattern, [{
    key: _Symbol.reflection,
    value: function () {
      return {
...
var CommonDataRequirementsInt = function () {
  function CommonDataRequirementsInt(primitiveType, minValue, maxValue) {
    _classCallCheck$1(this, CommonDataRequirementsInt);
  ...
  _createClass$1(CommonDataRequirementsInt, [{
    key: _Symbol.reflection,
    value: function () {
      return {
...
var CommonDataRequirementsDecimal = function () {
  function CommonDataRequirementsDecimal(size, precision, primitiveType, minValue, maxValue) {
    _classCallCheck$1(this, CommonDataRequirementsDecimal);
  ...
  _createClass$1(CommonDataRequirementsDecimal, [{
    key: _Symbol.reflection,
    value: function () {
      return {
...
var CommonDataRequirementsDate = function () {
  function CommonDataRequirementsDate(primitiveType, minValue, maxValue) {
    _classCallCheck$1(this, CommonDataRequirementsDate);
  ...
  _createClass$1(CommonDataRequirementsDate, [{
    key: _Symbol.reflection,
    value: function () {
      return {
...
var CommonDataRequirements = function () {
  function CommonDataRequirements(caseName, fields) {
    _classCallCheck$1(this, CommonDataRequirements);

    this.Case = caseName;
    this.Fields = fields;
  }

  _createClass$1(CommonDataRequirements, [{
    key: _Symbol.reflection,
    value: function () {
      return {
...
var SummaryError = function () {
  function SummaryError(errorCode, description) {
    _classCallCheck$1(this, SummaryError);

    this.ErrorCode = errorCode;
    this.Description = description;
  }

  _createClass$1(SummaryError, [{
    key: _Symbol.reflection,
    value: function () {
      return {
...
var PropertyError = function () {
  function PropertyError(errorCode, description, propertyName) {
    _classCallCheck$1(this, PropertyError);
  ...
  _createClass$1(PropertyError, [{
    ...
    key: "ToString",
    value: function () {
      return this.DisplayAsPropErrorString();
    }
  }, {
...
var ApiResultRendition = function () {
  function ApiResultRendition(content, reportableErrors) {
    _classCallCheck$1(this, ApiResultRendition);

    this.Content = content;
    this.ReportableErrors = reportableErrors;
  }

  _createClass$1(ApiResultRendition, [{
    key: _Symbol.reflection,
    value: function () {
      return {
  ...
  var Trial = __exports.Trial = function (__exports) {
    var TrialBuilder = __exports.TrialBuilder = function () {
      ...
      function TrialBuilder() {
        _classCallCheck$2(this, TrialBuilder);
      }
...
var CommonValidations = function (__exports) {
  var ValidateDataRequirementsStr = __exports.ValidateDataRequirementsStr = function (req, propName, value) {
    var validations = map$1(function (option) {
      ...
      var $var16 = void 0;
      var activePatternResult445 = void 0;
      var $var17 = e;

      if ($var17.Case === "Bad") {
        activePatternResult445 = new Choice("Choice3Of3", [$var17.Fields[0]]);
      } else if ($var17.Fields[1].tail == null) {
        activePatternResult445 = new Choice("Choice1Of3", [$var17.Fields[0]]);
      } else {
        activePatternResult445 = new Choice("Choice2Of3", [[$var17.Fields[0], $var17.Fields[1]]]);
      }

      if (activePatternResult445.Case === "Choice3Of3") {
        if (activePatternResult445.Fields[0].tail != null) {
          $var16 = [0, activePatternResult445.Fields[0].head, activePatternResult445.Fields[0].tail];
        } else {
          $var16 = [1];
        }
      } else {
  ...
  var ValidateDataRequirementsStrPattern = __exports.ValidateDataRequirementsStrPattern = function (req, propName, value) {
    var validations = map$1(function (option) {
      ...
      var $var22 = void 0;
      var activePatternResult452 = void 0;
      var $var23 = e;

      if ($var23.Case === "Bad") {
        activePatternResult452 = new Choice("Choice3Of3", [$var23.Fields[0]]);
      } else if ($var23.Fields[1].tail == null) {
        activePatternResult452 = new Choice("Choice1Of3", [$var23.Fields[0]]);
      } else {
        activePatternResult452 = new Choice("Choice2Of3", [[$var23.Fields[0], $var23.Fields[1]]]);
      }

      if (activePatternResult452.Case === "Choice3Of3") {
        if (activePatternResult452.Fields[0].tail != null) {
          $var22 = [0, activePatternResult452.Fields[0].head, activePatternResult452.Fields[0].tail];
        } else {
          $var22 = [1];
        }
      } else {
  ...
  var ValidateDataRequirementsInt = __exports.ValidateDataRequirementsInt = function (req, propName, value) {
    var validations = map$1(function (option) {
      ...
      var $var29 = void 0;
      var activePatternResult461 = void 0;
      var $var30 = e;

      if ($var30.Case === "Bad") {
        activePatternResult461 = new Choice("Choice3Of3", [$var30.Fields[0]]);
      } else if ($var30.Fields[1].tail == null) {
        activePatternResult461 = new Choice("Choice1Of3", [$var30.Fields[0]]);
      } else {
        activePatternResult461 = new Choice("Choice2Of3", [[$var30.Fields[0], $var30.Fields[1]]]);
      }

      if (activePatternResult461.Case === "Choice3Of3") {
        if (activePatternResult461.Fields[0].tail != null) {
          $var29 = [0, activePatternResult461.Fields[0].head, activePatternResult461.Fields[0].tail];
        } else {
          $var29 = [1];
        }
      } else {
  ...
  var ValidateDataRequirementsDecimal = __exports.ValidateDataRequirementsDecimal = function (req, propName, value) {
    var validations = map$1(function (option) {
      ...
      var $var31 = void 0;
      var activePatternResult466 = void 0;
      var $var32 = e;

      if ($var32.Case === "Bad") {
        activePatternResult466 = new Choice("Choice3Of3", [$var32.Fields[0]]);
      } else if ($var32.Fields[1].tail == null) {
        activePatternResult466 = new Choice("Choice1Of3", [$var32.Fields[0]]);
      } else {
        activePatternResult466 = new Choice("Choice2Of3", [[$var32.Fields[0], $var32.Fields[1]]]);
      }

      if (activePatternResult466.Case === "Choice3Of3") {
        if (activePatternResult466.Fields[0].tail != null) {
          $var31 = [0, activePatternResult466.Fields[0].head, activePatternResult466.Fields[0].tail];
        } else {
          $var31 = [1];
        }
      } else {
  ...
  var ValidateDataRequirementsDate = __exports.ValidateDataRequirementsDate = function (req, propName, value) {
    var validations = map$1(function (option) {
      ...
      var $var33 = void 0;
      var activePatternResult471 = void 0;
      var $var34 = e;

      if ($var34.Case === "Bad") {
        activePatternResult471 = new Choice("Choice3Of3", [$var34.Fields[0]]);
      } else if ($var34.Fields[1].tail == null) {
        activePatternResult471 = new Choice("Choice1Of3", [$var34.Fields[0]]);
      } else {
        activePatternResult471 = new Choice("Choice2Of3", [[$var34.Fields[0], $var34.Fields[1]]]);
      }

      if (activePatternResult471.Case === "Choice3Of3") {
        if (activePatternResult471.Fields[0].tail != null) {
          $var33 = [0, activePatternResult471.Fields[0].head, activePatternResult471.Fields[0].tail];
        } else {
          $var33 = [1];
        }
      } else {
  ...
  var ValidateAll = __exports.ValidateAll = function (validations, req) {
    var allResults = collect$1(function (e) {
      var activePatternResult479 = void 0;
      var $var35 = e;

      if ($var35.Case === "Bad") {
        activePatternResult479 = new Choice("Choice3Of3", [$var35.Fields[0]]);
      } else if ($var35.Fields[1].tail == null) {
        activePatternResult479 = new Choice("Choice1Of3", [$var35.Fields[0]]);
      } else {
        activePatternResult479 = new Choice("Choice2Of3", [[$var35.Fields[0], $var35.Fields[1]]]);
      }

      if (activePatternResult479.Case === "Choice3Of3") {
        return activePatternResult479.Fields[0];
      } else {
        return new List$1();
      }
    }, filter$1(function (r) {
      ...
      if ($var36.Case === "Bad") {
        activePatternResult477 = new Choice("Choice3Of3", [$var36.Fields[0]]);
      } else if ($var36.Fields[1].tail == null) {
        activePatternResult477 = new Choice("Choice1Of3", [$var36.Fields[0]]);
      } else {
        activePatternResult477 = new Choice("Choice2Of3", [[$var36.Fields[0], $var36.Fields[1]]]);
      }
  ...
  var MergeResults = __exports.MergeResults = function (results, passValue) {
    var allErrors = concat$1(map$1(function (r) {
      var $var37 = void 0;
      var activePatternResult484 = void 0;
      var $var38 = r;

      if ($var38.Case === "Bad") {
        activePatternResult484 = new Choice("Choice3Of3", [$var38.Fields[0]]);
      } else if ($var38.Fields[1].tail == null) {
        activePatternResult484 = new Choice("Choice1Of3", [$var38.Fields[0]]);
      } else {
        activePatternResult484 = new Choice("Choice2Of3", [[$var38.Fields[0], $var38.Fields[1]]]);
      }

      if (activePatternResult484.Case === "Choice3Of3") {
        if (activePatternResult484.Fields[0].tail != null) {
          $var37 = [0, activePatternResult484.Fields[0].head];
        } else {
          $var37 = [1];
        }
      } else {
    ...
    var matchValue = isEmpty(allErrors);

    if (matchValue) {
      return new Chessie.Result("Ok", [passValue, new List$1()]);
    } else {
      return new Chessie.Result("Bad", [ofArray([allErrors])]);
    }
  };

  var CollectAllValidated = __exports.CollectAllValidated = function (results) {
    var allErrors = concat$1(map$1(function (r) {
      var $var39 = void 0;
      var activePatternResult489 = void 0;
      var $var40 = r;

      if ($var40.Case === "Bad") {
        activePatternResult489 = new Choice("Choice3Of3", [$var40.Fields[0]]);
      } else if ($var40.Fields[1].tail == null) {
        activePatternResult489 = new Choice("Choice1Of3", [$var40.Fields[0]]);
      } else {
        activePatternResult489 = new Choice("Choice2Of3", [[$var40.Fields[0], $var40.Fields[1]]]);
      }

      if (activePatternResult489.Case === "Choice3Of3") {
        if (activePatternResult489.Fields[0].tail != null) {
          $var39 = [0, activePatternResult489.Fields[0].head];
        } else {
          $var39 = [1];
        }
      } else {
    ...
    var allGoodObjs = concat$1(map$1(function (r_1) {
      var $var41 = void 0;

      if (r_1.Case === "Ok") {
        $var41 = [0, r_1.Fields[0]];
      } else {
        var activePatternResult491 = void 0;
        var $var42 = r_1;

        if ($var42.Case === "Bad") {
          activePatternResult491 = new Choice("Choice3Of3", [$var42.Fields[0]]);
        } else if ($var42.Fields[1].tail == null) {
          activePatternResult491 = new Choice("Choice1Of3", [$var42.Fields[0]]);
        } else {
          activePatternResult491 = new Choice("Choice2Of3", [[$var42.Fields[0], $var42.Fields[1]]]);
        }

        if (activePatternResult491.Case === "Choice3Of3") {
          if (activePatternResult491.Fields[0].tail != null) {
            $var41 = [1, activePatternResult491.Fields[0].head];
          } else {
            $var41 = [2];
          }
        } else {
      ...
      switch ($var41[0]) {
        case 0:
          return ofArray([$var41[1]]);

        case 1:
          return new List$1();

        case 2:
          throw new Error("C:\\Sources\\Repos\\LN\\lnAppl\\XpressLoanRequest\\Lr.Core\\../paket-files/csbfl-tfs18080/tfs/TFS2015Projects/_git/DEV-FsCommons/FsCommons/FsCommons.Core/CommonValidations.fs", 431, 26);
      }
    }, results));
    var matchValue = isEmpty(allErrors);

    if (matchValue) {
      return new Chessie.Result("Ok", [allGoodObjs, new List$1()]);
    } else {
      return new Chessie.Result("Bad", [ofArray([allErrors])]);
    }
  };
  ...
  var ValidateAllResults = __exports.ValidateAllResults = function (results, onAllGood) {
    var allResults = collect$1(function (e) {
      var activePatternResult497 = void 0;
      var $var43 = e;

      if ($var43.Case === "Bad") {
        activePatternResult497 = new Choice("Choice3Of3", [$var43.Fields[0]]);
      } else if ($var43.Fields[1].tail == null) {
        activePatternResult497 = new Choice("Choice1Of3", [$var43.Fields[0]]);
      } else {
        activePatternResult497 = new Choice("Choice2Of3", [[$var43.Fields[0], $var43.Fields[1]]]);
      }

      if (activePatternResult497.Case === "Choice3Of3") {
        return activePatternResult497.Fields[0];
      } else {
        return new List$1();
      }
    }, filter$1(function (r) {
      var activePatternResult495 = void 0;
      var $var44 = r;

      if ($var44.Case === "Bad") {
        activePatternResult495 = new Choice("Choice3Of3", [$var44.Fields[0]]);
      } else if ($var44.Fields[1].tail == null) {
        activePatternResult495 = new Choice("Choice1Of3", [$var44.Fields[0]]);
      } else {
        activePatternResult495 = new Choice("Choice2Of3", [[$var44.Fields[0], $var44.Fields[1]]]);
      }

      if (activePatternResult495.Case === "Choice3Of3") {
        return true;
      } else {
        return false;
      }
  ...
  var MustBeSome = __exports.MustBeSome = function (propName, opt) {
    if (opt == null) {
      return new Chessie.Result("Bad", [ofArray([ofArray([new PropertyError("MustBeSome", "Record must exist", propName)])])]);
    } else {
      return new Chessie.Result("Ok", [opt, new List$1()]);
    }
  };
...
var BzProp = function () {
  function BzProp(caseName, fields) {
    _classCallCheck$5(this, BzProp);

    this.Case = caseName;
    this.Fields = fields;
  }

  _createClass$5(BzProp, [{
    key: _Symbol.reflection,
    value: function () {
      return {
...
function BzPropToResult(bzProp) {
  if (bzProp.Case === "Invalid") {
    var newValue = bzProp.Fields[0][0];
    var errors = bzProp.Fields[0][1];
    return new Chessie.Result("Bad", [ofArray([errors])]);
  } else {
    return new Chessie.Result("Ok", [bzProp.Fields[0], new List$1()]);
  }
}
function BzPropToRendtion(bzProp) {
  if (bzProp.Case === "Invalid") {
    var newValue = bzProp.Fields[0][0];
    var errors = bzProp.Fields[0][1];
    return toString(newValue);
  } else {
    return toString(bzProp.Fields[0]);
  }
}
...
var YesNo = function () {
  function YesNo(innerVal) {
    _classCallCheck$5(this, YesNo);

    this.innerVal = innerVal;
  }

  _createClass$5(YesNo, [{
    key: _Symbol.reflection,
    value: function () {
      return {
...
var ShortName = function () {
  function ShortName(innerVal) {
    _classCallCheck$5(this, ShortName);

    this.innerVal = innerVal;
  }

  _createClass$5(ShortName, [{
    key: _Symbol.reflection,
    value: function () {
      return {
...
var OptionalEntry = function () {
  function OptionalEntry(innerVal) {
    _classCallCheck$5(this, OptionalEntry);

    this.innerVal = innerVal;
  }

  _createClass$5(OptionalEntry, [{
    key: _Symbol.reflection,
    value: function () {
      return {
...
var LongName = function () {
  function LongName(innerVal) {
    _classCallCheck$5(this, LongName);

    this.innerVal = innerVal;
  }

  _createClass$5(LongName, [{
    key: _Symbol.reflection,
    value: function () {
      return {
...
var PersonName = function () {
  function PersonName(firstName, middleName, lastName) {
    _classCallCheck$5(this, PersonName);
...
var AddressStreetLine = function () {
  function AddressStreetLine(innerVal) {
    _classCallCheck$5(this, AddressStreetLine);

    this.innerVal = innerVal;
  }

  _createClass$5(AddressStreetLine, [{
    key: _Symbol.reflection,
    value: function () {
      return {
...
var AddressCity = function () {
  function AddressCity(innerVal) {
    _classCallCheck$5(this, AddressCity);

    this.innerVal = innerVal;
  }

  _createClass$5(AddressCity, [{
    key: _Symbol.reflection,
    value: function () {
      return {
...
var AddressStateCode = function () {
  function AddressStateCode(innerVal) {
    _classCallCheck$5(this, AddressStateCode);

    this.innerVal = innerVal;
  }

  _createClass$5(AddressStateCode, [{
    key: _Symbol.reflection,
    value: function () {
      return {
...
var AddressZipCode = function () {
  function AddressZipCode(innerVal) {
    _classCallCheck$5(this, AddressZipCode);

    this.innerVal = innerVal;
  }

  _createClass$5(AddressZipCode, [{
    key: _Symbol.reflection,
    value: function () {
      return {
...
var UsAddress = function () {
  function UsAddress(addressStreet1, addressCity, addressStateCode, addressZipCode) {
    _classCallCheck$5(this, UsAddress);
...
var UniqueId = function () {
  function UniqueId(innerVal) {
    _classCallCheck$5(this, UniqueId);

    this.innerVal = innerVal;
  }

  _createClass$5(UniqueId, [{
    key: _Symbol.reflection,
    value: function () {
      return {
...
var PositiveInt = function () {
  function PositiveInt(innerVal) {
    _classCallCheck$5(this, PositiveInt);

    this.innerVal = innerVal;
  }

  _createClass$5(PositiveInt, [{
    key: _Symbol.reflection,
    value: function () {
      return {
        type: "FsCommons.Core.BusinessTypes.PositiveInt",
        interfaces: ["FSharpRecord", "System.IEquatable", "System.IComparable"],
        properties: {
          innerVal: "number"
        }
    ...
    key: "GetCommonDataRequirements",
    value: function () {
      return PositiveInt.commonDataReqs;
    }
  }, {
    key: "FromRendition",
    value: function (newValue) {
      return createPropIntStr(PositiveInt.commonDataReqs, function (r) {
        return new PositiveInt(r);
      }, "", newValue);
    }
  }, {
    key: "ToRendition",
    value: function (obj) {
      return String(obj.innerVal);
    }
  }, {
    key: "commonDataReqs",
    get: function () {
      return new CommonDataRequirementsInt(new PrimitiveTypes("Integer", []), 1, 99999999);
    }
  }]);

  return PositiveInt;
}();
setType("FsCommons.Core.BusinessTypes.PositiveInt", PositiveInt);
var PositiveMoneyAmount = function () {
  function PositiveMoneyAmount(innerVal) {
    _classCallCheck$5(this, PositiveMoneyAmount);

    this.innerVal = innerVal;
  }

  _createClass$5(PositiveMoneyAmount, [{
    key: _Symbol.reflection,
    value: function () {
      return {
...
var UsTaxId = function () {
  function UsTaxId(innerVal) {
    _classCallCheck$5(this, UsTaxId);

    this.innerVal = innerVal;
  }

  _createClass$5(UsTaxId, [{
    key: _Symbol.reflection,
    value: function () {
      return {
...
var UsPhone = function () {
  function UsPhone(innerVal) {
    _classCallCheck$5(this, UsPhone);

    this.innerVal = innerVal;
  }

  _createClass$5(UsPhone, [{
    key: _Symbol.reflection,
    value: function () {
      return {
...
var RequiredCount = function () {
  function RequiredCount(innerVal, strVal) {
    _classCallCheck$5(this, RequiredCount);

    this.innerVal = innerVal;
    this.strVal = strVal;
  }

  _createClass$5(RequiredCount, [{
    key: _Symbol.reflection,
    value: function () {
      return {
...
var PositivePercentage = function () {
  function PositivePercentage(innerVal) {
    _classCallCheck$5(this, PositivePercentage);

    this.innerVal = innerVal;
  }

  _createClass$5(PositivePercentage, [{
    key: _Symbol.reflection,
    value: function () {
      return {
...
var EmailAddress = function () {
  function EmailAddress(innerVal) {
    _classCallCheck$5(this, EmailAddress);

    this.innerVal = innerVal;
  }

  _createClass$5(EmailAddress, [{
    key: _Symbol.reflection,
    value: function () {
      return {
...
var PastDate = function () {
  function PastDate(innerVal) {
    _classCallCheck$5(this, PastDate);

    this.innerVal = innerVal;
  }

  _createClass$5(PastDate, [{
    key: _Symbol.reflection,
    value: function () {
      return {
...
var FutureDate = function () {
  function FutureDate(innerVal) {
    _classCallCheck$5(this, FutureDate);

    this.innerVal = innerVal;
  }

  _createClass$5(FutureDate, [{
    key: _Symbol.reflection,
    value: function () {
      return {
...
var LkupValue = function () {
  function LkupValue(idValue, label) {
    _classCallCheck$4(this, LkupValue);

    this.IdValue = idValue;
    this.Label = label;
  }

  _createClass$4(LkupValue, [{
    key: _Symbol.reflection,
    value: function () {
      return {
...
var BleAmountRequested = function () {
  function BleAmountRequested(innerVal) {
    _classCallCheck$4(this, BleAmountRequested);

    this.innerVal = innerVal;
  }

  _createClass$4(BleAmountRequested, [{
    key: _Symbol.reflection,
    value: function () {
      return {
...
var LoanType = function () {
  function LoanType(innerVal) {
    _classCallCheck$4(this, LoanType);

    this.innerVal = innerVal;
  }

  _createClass$4(LoanType, [{
    key: _Symbol.reflection,
    value: function () {
      return {
...
var LoanPurpose = function () {
  function LoanPurpose(innerVal) {
    _classCallCheck$4(this, LoanPurpose);

    this.innerVal = innerVal;
  }

  _createClass$4(LoanPurpose, [{
    key: _Symbol.reflection,
    value: function () {
      return {
...
var EcoaAnswer = function () {
  function EcoaAnswer(innerVal) {
    _classCallCheck$4(this, EcoaAnswer);

    this.innerVal = innerVal;
  }

  _createClass$4(EcoaAnswer, [{
    key: _Symbol.reflection,
    value: function () {
      return {
    ...
    value: function (propName, newValueRaw, grossRev) {
      ...
      if (validationResult.Case === "Bad") {
        ...
        var $var109 = newValue === "Y" ? grossRev + 0 <= 1000000 ? [0] : [1] : [1];
        ...
        switch ($var109[0]) {
          ...
          case 1:
            var $var110 = newValue === "N" ? grossRev + 0 > 1000000 ? [0] : [1] : [1];
...
var LoanDocType = function () {
  function LoanDocType(caseName, fields) {
    _classCallCheck$4(this, LoanDocType);

    this.Case = caseName;
    this.Fields = fields;
  }

  _createClass$4(LoanDocType, [{
    key: _Symbol.reflection,
    value: function () {
      return {
...
var NeededOn = function () {
  function NeededOn(caseName, fields) {
    _classCallCheck$4(this, NeededOn);

    this.Case = caseName;
    this.Fields = fields;
  }

  _createClass$4(NeededOn, [{
    key: _Symbol.reflection,
    value: function () {
      return {
...
var NeededFrom = function () {
  function NeededFrom(caseName, fields) {
    _classCallCheck$4(this, NeededFrom);

    this.Case = caseName;
    this.Fields = fields;
  }

  _createClass$4(NeededFrom, [{
    key: _Symbol.reflection,
    value: function () {
      return {
...
var LoanDocRequirement = function () {
  function LoanDocRequirement(attachmentRequirementBucketName, loanDocType, neededOn, neededFrom, isNeededForFinancials) {
    _classCallCheck$4(this, LoanDocRequirement);
    ...
    this.IsNeededForFinancials = isNeededForFinancials;
  }

  _createClass$4(LoanDocRequirement, [{
    key: _Symbol.reflection,
    value: function () {
      return {
...
var LoanDoc = function () {
  function LoanDoc(attachmentName) {
    _classCallCheck$4(this, LoanDoc);

    this.AttachmentName = attachmentName;
  }

  _createClass$4(LoanDoc, [{
    key: _Symbol.reflection,
    value: function () {
      return {
...
var LoanDocUpload = function () {
  function LoanDocUpload(loanRequestId, requirementBucket, attachmentName, contents, username) {
    _classCallCheck$4(this, LoanDocUpload);
...
var DocRequirementFulfilment = function () {
  function DocRequirementFulfilment(loadDocRequirement, loanDocs) {
    _classCallCheck$4(this, DocRequirementFulfilment);

    this.LoadDocRequirement = loadDocRequirement;
    this.LoanDocs = loanDocs;
  }

  _createClass$4(DocRequirementFulfilment, [{
    key: _Symbol.reflection,
    value: function () {
      return {
...
var Collateral = function () {
  function Collateral(seqNumber, specificDescription, collateralType, docRequirementFulfilment) {
    _classCallCheck$4(this, Collateral);
...
var Company = function () {
  function Company(companyId, taxId, companyType, grossAnnualRevenue, registeredName, tradeName, businessPhone, dateEstablished, stateCodeStablished, loanIndustry, natureOfBusiness, legalStatus, registrationNumber, stateFilingUrl, isOneYearFinancialsRequired, revenueMoreThanOneMillion, physicalAddress, isPhysicalSameAsMailing, mailingAddress, modifiedBy, modifiedOn, hasRequestedToApplyJointly, dDACollectiveBalance, docRequirementFulfilment) {
    _classCallCheck$4(this, Company);
...
var EntityTypeClass = function () {
  function EntityTypeClass(caseName, fields) {
    _classCallCheck$4(this, EntityTypeClass);

    this.Case = caseName;
    this.Fields = fields;
  }

  _createClass$4(EntityTypeClass, [{
    key: _Symbol.reflection,
    value: function () {
      return {
...
var EntityType = function () {
  function EntityType(innerVal, classification) {
    _classCallCheck$4(this, EntityType);

    this.innerVal = innerVal;
    this.classification = classification;
  }

  _createClass$4(EntityType, [{
    key: _Symbol.reflection,
    value: function () {
      return {
...
var EntityRelationship = function () {
  function EntityRelationship(innerVal) {
    _classCallCheck$4(this, EntityRelationship);

    this.innerVal = innerVal;
  }

  _createClass$4(EntityRelationship, [{
    key: _Symbol.reflection,
    value: function () {
      return {
...
var RelatedEntity = function () {
  function RelatedEntity(entityIdInRequest, entityType, taxId, personName, businessName, ownershipPercent, mainAddress, dateOfBirth, hasDeclaredBankruptcy, hasOutstandingLiens, iDType, iDNumber, issuer, expirationDate, issueDate, emailAddress, businessPhone, isPrimaryContact, entityRelationship, relatedSince, netWorth, combinedIncome, docRequirementFulfilment) {
    _classCallCheck$4(this, RelatedEntity);
...
var LoanRequestBaseInfo = function () {
  function LoanRequestBaseInfo(loanRequestId, loanType, isSecured, amountRequested, loanPurpose, specificPurpose) {
    _classCallCheck$4(this, LoanRequestBaseInfo);
  ...
  _createClass$4(LoanRequestBaseInfo, [{
    key: _Symbol.reflection,
    value: function () {
      return {
...
var CoreBalance = function () {
  function CoreBalance(acctNumber, currentPrincipalBalance, creditRiskCode, balanceAsOf) {
    _classCallCheck$4(this, CoreBalance);
...
var CoreAggregatedBalance = function () {
  function CoreAggregatedBalance(coreBalances, newAmountRequested) {
    _classCallCheck$4(this, CoreAggregatedBalance);

    this.CoreBalances = coreBalances;
    this.NewAmountRequested = newAmountRequested;
  }

  _createClass$4(CoreAggregatedBalance, [{
    key: _Symbol.reflection,
    value: function () {
      return {
...
var CoreBalanceRequest = function () {
  function CoreBalanceRequest(requestorTaxId, newAmountRequested) {
    _classCallCheck$4(this, CoreBalanceRequest);

    this.RequestorTaxId = requestorTaxId;
    this.NewAmountRequested = newAmountRequested;
  }

  _createClass$4(CoreBalanceRequest, [{
    key: _Symbol.reflection,
    value: function () {
      return {
...
var LoanRequest = function () {
  function LoanRequest(lrId, requestBaseInfo, requestingCompany, collateral, relatedEntities, aggregatedBalacesInfo, modifiedBy, modifiedOn) {
    _classCallCheck$4(this, LoanRequest);
...
var AppLookupInfo = function () {
  function AppLookupInfo(possibleCollateralTypes, possibleLoanPurposes, possibleLoanTypes, possibleIndustryCodes, possibleSectorCodes) {
    _classCallCheck$4(this, AppLookupInfo);
...
var CollateralDocument = function () {
  function CollateralDocument(collateralDocumentId, collateralId, docRequirement, referToDocumentId, attachmentId) {
    _classCallCheck$4(this, CollateralDocument);
  ...
  _createClass$4(CollateralDocument, [{
    key: _Symbol.reflection,
    value: function () {
      return {
...
var LightSwitchRenditionTypes = function (__exports) {
  var RenditionUsAddress = __exports.RenditionUsAddress = function () {
    function RenditionUsAddress(addressStreet1, addressCity, addressStateCode, addressZipCode) {
      _classCallCheck$3(this, RenditionUsAddress);
    ...
    _createClass$3(RenditionUsAddress, [{
      key: _Symbol.reflection,
      value: function () {
        return {
          type: "Lr.InTake.Core.LightSwitchRenditionTypes.RenditionUsAddress",
          interfaces: ["FSharpRecord", "System.IEquatable", "System.IComparable"],
          properties: {
    ...
    return RenditionUsAddress;
  }();

  setType("Lr.InTake.Core.LightSwitchRenditionTypes.RenditionUsAddress", RenditionUsAddress);

  var UsAddressRenditionHelpers = __exports.UsAddressRenditionHelpers = function (__exports) {
    var Empty = __exports.Empty = new RenditionUsAddress("", "", "", "");
    return __exports;
  }({});

  var RenditionPersonName = __exports.RenditionPersonName = function () {
    function RenditionPersonName(firstName, middleName, lastName) {
      _classCallCheck$3(this, RenditionPersonName);
    ...
    _createClass$3(RenditionPersonName, [{
      key: _Symbol.reflection,
      value: function () {
        return {
          type: "Lr.InTake.Core.LightSwitchRenditionTypes.RenditionPersonName",
          interfaces: ["FSharpRecord", "System.IEquatable", "System.IComparable"],
          properties: {
            firstName: "string",
            middleName: "string",
    ...
    return RenditionPersonName;
  }();

  setType("Lr.InTake.Core.LightSwitchRenditionTypes.RenditionPersonName", RenditionPersonName);

  var PersonNameRenditionHelpers = __exports.PersonNameRenditionHelpers = function (__exports) {
    var Empty = __exports.Empty = new RenditionPersonName("", "", "");

    var ToFullName = __exports.ToFullName = function (model) {
  ...
  var RenditionLoanDoc = __exports.RenditionLoanDoc = function () {
    function RenditionLoanDoc(docId, attachmentName) {
      _classCallCheck$3(this, RenditionLoanDoc);

      this.DocId = docId;
      this.AttachmentName = attachmentName;
    }

    _createClass$3(RenditionLoanDoc, [{
      key: _Symbol.reflection,
      value: function () {
        return {
          type: "Lr.InTake.Core.LightSwitchRenditionTypes.RenditionLoanDoc",
          interfaces: ["FSharpRecord", "System.IEquatable", "System.IComparable"],
          properties: {
            DocId: "number",
            AttachmentName: "string"
    ...
    return RenditionLoanDoc;
  }();

  setType("Lr.InTake.Core.LightSwitchRenditionTypes.RenditionLoanDoc", RenditionLoanDoc);

  var RenditionLoanDocRequirement = __exports.RenditionLoanDocRequirement = function () {
    function RenditionLoanDocRequirement(attachmentRequirementBucketName, loanDocType, neededOn, neededFrom, isNeededForFinancials) {
      _classCallCheck$3(this, RenditionLoanDocRequirement);
    ...
    _createClass$3(RenditionLoanDocRequirement, [{
      key: _Symbol.reflection,
      value: function () {
        return {
          type: "Lr.InTake.Core.LightSwitchRenditionTypes.RenditionLoanDocRequirement",
          interfaces: ["FSharpRecord", "System.IEquatable", "System.IComparable"],
          properties: {
            AttachmentRequirementBucketName: "string",
            LoanDocType: "string",
    ...
    return RenditionLoanDocRequirement;
  }();

  setType("Lr.InTake.Core.LightSwitchRenditionTypes.RenditionLoanDocRequirement", RenditionLoanDocRequirement);

  var RenditionDocRequirementFulfilment = __exports.RenditionDocRequirementFulfilment = function () {
    function RenditionDocRequirementFulfilment(loanDocRequirement, loanDocs) {
      _classCallCheck$3(this, RenditionDocRequirementFulfilment);

      this.LoanDocRequirement = loanDocRequirement;
      this.LoanDocs = loanDocs;
    }

    _createClass$3(RenditionDocRequirementFulfilment, [{
      key: _Symbol.reflection,
      value: function () {
        return {
          type: "Lr.InTake.Core.LightSwitchRenditionTypes.RenditionDocRequirementFulfilment",
          interfaces: ["FSharpRecord", "System.IEquatable"],
          properties: {
            LoanDocRequirement: RenditionLoanDocRequirement,
            LoanDocs: Interface("System.Collections.Generic.IEnumerable")
          }
        };
      }
    }, {
    ...
    return RenditionDocRequirementFulfilment;
  }();

  setType("Lr.InTake.Core.LightSwitchRenditionTypes.RenditionDocRequirementFulfilment", RenditionDocRequirementFulfilment);

  var RenditionCompanyDocument = __exports.RenditionCompanyDocument = function () {
    function RenditionCompanyDocument(registeredCompanyName, docTypeName, documentName, documentId, companyId) {
      _classCallCheck$3(this, RenditionCompanyDocument);
    ...
    _createClass$3(RenditionCompanyDocument, [{
      key: _Symbol.reflection,
      value: function () {
        return {
          type: "Lr.InTake.Core.LightSwitchRenditionTypes.RenditionCompanyDocument",
          interfaces: ["FSharpRecord", "System.IEquatable", "System.IComparable"],
          properties: {
    ...
    return RenditionCompanyDocument;
  }();

  setType("Lr.InTake.Core.LightSwitchRenditionTypes.RenditionCompanyDocument", RenditionCompanyDocument);

  var RenditionRelatedEntityDocument = __exports.RenditionRelatedEntityDocument = function () {
    function RenditionRelatedEntityDocument(relatedEntityName, docTypeName, documentName, documentId, relatedEntityId) {
      _classCallCheck$3(this, RenditionRelatedEntityDocument);
    ...
    _createClass$3(RenditionRelatedEntityDocument, [{
      key: _Symbol.reflection,
      value: function () {
        return {
          type: "Lr.InTake.Core.LightSwitchRenditionTypes.RenditionRelatedEntityDocument",
          interfaces: ["FSharpRecord", "System.IEquatable", "System.IComparable"],
          properties: {
    ...
    return RenditionRelatedEntityDocument;
  }();

  setType("Lr.InTake.Core.LightSwitchRenditionTypes.RenditionRelatedEntityDocument", RenditionRelatedEntityDocument);

  var RenditionCollateralDocument = __exports.RenditionCollateralDocument = function () {
    function RenditionCollateralDocument(specificDescription, collateralType, docTypeName, documentName, documentId, collateralId) {
      _classCallCheck$3(this, RenditionCollateralDocument);
    ...
    _createClass$3(RenditionCollateralDocument, [{
      key: _Symbol.reflection,
      value: function () {
        return {
          type: "Lr.InTake.Core.LightSwitchRenditionTypes.RenditionCollateralDocument",
          interfaces: ["FSharpRecord", "System.IEquatable", "System.IComparable"],
          properties: {
    ...
    return RenditionCollateralDocument;
  }();

  setType("Lr.InTake.Core.LightSwitchRenditionTypes.RenditionCollateralDocument", RenditionCollateralDocument);

  var RenditionIncomeAmount = __exports.RenditionIncomeAmount = function () {
    function RenditionIncomeAmount(relatedEntityId, salary, bonusandCommissions, interestandDividends, recurringCapitalGains, recurringRealEstateIncome, recurringOtherIncome, totalAnnualIncome, totalMonthlyIncome) {
      _classCallCheck$3(this, RenditionIncomeAmount);

      this.RelatedEntityId = relatedEntityId;
      this.Salary = salary;
      this.BonusandCommissions = bonusandCommissions;
      this.InterestandDividends = interestandDividends;
      this.RecurringCapitalGains = recurringCapitalGains;
      this.RecurringRealEstateIncome = recurringRealEstateIncome;
      this.RecurringOtherIncome = recurringOtherIncome;
      this.TotalAnnualIncome = totalAnnualIncome;
      this.TotalMonthlyIncome = totalMonthlyIncome;
    }

    _createClass$3(RenditionIncomeAmount, [{
      key: _Symbol.reflection,
      value: function () {
        return {
          type: "Lr.InTake.Core.LightSwitchRenditionTypes.RenditionIncomeAmount",
          interfaces: ["FSharpRecord", "System.IEquatable", "System.IComparable"],
          properties: {
            RelatedEntityId: "number",
            Salary: "number",
            BonusandCommissions: "number",
            InterestandDividends: "number",
            RecurringCapitalGains: "number",
            RecurringRealEstateIncome: "number",
    ...
    return RenditionIncomeAmount;
  }();

  setType("Lr.InTake.Core.LightSwitchRenditionTypes.RenditionIncomeAmount", RenditionIncomeAmount);

  var RenditionNetWorthAmount = __exports.RenditionNetWorthAmount = function () {
    function RenditionNetWorthAmount(relatedEntityId, realEstatePrimaryResidence, realEstateSecondHome, vehicles, personalProperty, checkingAccounts, savingsAccounts, certificatesOfDeposit, moneyMarketAccounts, lifeInsurance, other, retirementAccounts, publiclyTradedStocksAndBonds, realEstateRentalAndInvestment, valueOfPrivatelyHeldCompanies, mortgageLoanPrimaryResidence, homeEquityLoanPrimaryResidence, realEstateLoansSecondHome, realEstateLoansRentalInvestment, carLoans, studentLoans, creditCardDebt, otherDebt, assetsTotal, liabilitiesTotal, netWorth) {
      _classCallCheck$3(this, RenditionNetWorthAmount);

      this.RelatedEntityId = relatedEntityId;
      this.RealEstatePrimaryResidence = realEstatePrimaryResidence;
      this.RealEstateSecondHome = realEstateSecondHome;
      this.Vehicles = vehicles;
      this.PersonalProperty = personalProperty;
      this.CheckingAccounts = checkingAccounts;
      this.SavingsAccounts = savingsAccounts;
      this.CertificatesOfDeposit = certificatesOfDeposit;
      this.MoneyMarketAccounts = moneyMarketAccounts;
      this.LifeInsurance = lifeInsurance;
      this.Other = other;
      this.RetirementAccounts = retirementAccounts;
      this.PubliclyTradedStocksAndBonds = publiclyTradedStocksAndBonds;
      this.RealEstateRentalAndInvestment = realEstateRentalAndInvestment;
      this.ValueOfPrivatelyHeldCompanies = valueOfPrivatelyHeldCompanies;
      this.MortgageLoanPrimaryResidence = mortgageLoanPrimaryResidence;
      this.HomeEquityLoanPrimaryResidence = homeEquityLoanPrimaryResidence;
      this.RealEstateLoansSecondHome = realEstateLoansSecondHome;
      this.RealEstateLoansRentalInvestment = realEstateLoansRentalInvestment;
    ...
    _createClass$3(RenditionNetWorthAmount, [{
      key: _Symbol.reflection,
      value: function () {
        return {
          type: "Lr.InTake.Core.LightSwitchRenditionTypes.RenditionNetWorthAmount",
          interfaces: ["FSharpRecord", "System.IEquatable", "System.IComparable"],
          properties: {
            RelatedEntityId: "number",
            RealEstatePrimaryResidence: "number",
            RealEstateSecondHome: "number",
            Vehicles: "number",
            ...
            PubliclyTradedStocksAndBonds: "number",
            RealEstateRentalAndInvestment: "number",
            ValueOfPrivatelyHeldCompanies: "number",
            MortgageLoanPrimaryResidence: "number",
            HomeEquityLoanPrimaryResidence: "number",
            RealEstateLoansSecondHome: "number",
            RealEstateLoansRentalInvestment: "number",
            CarLoans: "number",
            StudentLoans: "number",
    ...
    return RenditionNetWorthAmount;
  }();

  setType("Lr.InTake.Core.LightSwitchRenditionTypes.RenditionNetWorthAmount", RenditionNetWorthAmount);

  var RenditionRelatedEntity = __exports.RenditionRelatedEntity = function () {
    function RenditionRelatedEntity(entityType, taxId, businessName, ownershipPercent, hasDeclaredBankruptcy, hasOutstandingLiens, iDType, iDNumber, issuer, emailAddress, isPrimaryContact, entityRelationship, entityIdInRequest, dateOfBirth, expirationDate, issueDate, personName, mainAddress, businessPhone, relatedSince, netWorth, combinedIncome, detailsOnCitizenship, isUSCitizen, docRequirementFulfilment, detailsOnLiens, detailsOnBankruptcy) {
      _classCallCheck$3(this, RenditionRelatedEntity);
      ...
      this.NetWorth = netWorth;
      this.CombinedIncome = combinedIncome;
      this.DetailsOnCitizenship = detailsOnCitizenship;
      this.IsUSCitizen = isUSCitizen;
      this.DocRequirementFulfilment = docRequirementFulfilment;
      this.DetailsOnLiens = detailsOnLiens;
      this.DetailsOnBankruptcy = detailsOnBankruptcy;
    }

    _createClass$3(RenditionRelatedEntity, [{
      key: _Symbol.reflection,
      value: function () {
        return {
          type: "Lr.InTake.Core.LightSwitchRenditionTypes.RenditionRelatedEntity",
          interfaces: ["FSharpRecord", "System.IEquatable"],
          properties: {
            EntityType: "string",
            TaxId: "string",
            ...
            HasDeclaredBankruptcy: "string",
            HasOutstandingLiens: "string",
            IDType: "string",
            IDNumber: "string",
            Issuer: "string",
            EmailAddress: "string",
            ...
            IssueDate: "string",
            PersonName: RenditionPersonName,
            MainAddress: RenditionUsAddress,
            BusinessPhone: "string",
            RelatedSince: "string",
            NetWorth: RenditionNetWorthAmount,
            CombinedIncome: RenditionIncomeAmount,
            DetailsOnCitizenship: "string",
            IsUSCitizen: "string",
            DocRequirementFulfilment: Interface("System.Collections.Generic.IEnumerable"),
            DetailsOnLiens: "string",
            DetailsOnBankruptcy: "string"
          }
        };
      }
    }, {
    ...
    return RenditionRelatedEntity;
  }();

  setType("Lr.InTake.Core.LightSwitchRenditionTypes.RenditionRelatedEntity", RenditionRelatedEntity);

  var RenditionRequestBaseInfo = __exports.RenditionRequestBaseInfo = function () {
    function RenditionRequestBaseInfo(requestStatus, loanType, isSecured, amountRequested, loanPurpose, specificPurpose, submittedOn, isOneYearFinancialsRequired) {
      _classCallCheck$3(this, RenditionRequestBaseInfo);
    ...
    _createClass$3(RenditionRequestBaseInfo, [{
      key: _Symbol.reflection,
      value: function () {
        return {
          type: "Lr.InTake.Core.LightSwitchRenditionTypes.RenditionRequestBaseInfo",
          interfaces: ["FSharpRecord", "System.IEquatable", "System.IComparable"],
          properties: {
            ...
            SubmittedOn: Option(Date),
            IsOneYearFinancialsRequired: "string"
          }
        };
      }
    }, {
    ...
    return RenditionRequestBaseInfo;
  }();

  setType("Lr.InTake.Core.LightSwitchRenditionTypes.RenditionRequestBaseInfo", RenditionRequestBaseInfo);

  var RequestBaseInfoRenditionHelpers = __exports.RequestBaseInfoRenditionHelpers = function (__exports) {
    var Empty = __exports.Empty = new RenditionRequestBaseInfo("", "", "", 0, "", "", null, "N");
    return __exports;
  }({});

  var RenditionCompany = __exports.RenditionCompany = function () {
    function RenditionCompany(companyId, taxId, companyType, grossAnnualRevenue, registeredName, tradeName, businessPhone, stateCodeStablished, loanIndustry, natureOfBusiness, legalStatus, registrationNumber, stateFilingUrl, revenueMoreThanOneMillion, isPhysicalSameAsMailing, hasRequestedToApplyJointly, dateEstablished, modifiedBy, modifiedOn, physicalAddress, mailingAddress, dDACollectiveBalance, docRequirementFulfilment) {
      _classCallCheck$3(this, RenditionCompany);
    ...
    _createClass$3(RenditionCompany, [{
      key: _Symbol.reflection,
      value: function () {
        return {
          type: "Lr.InTake.Core.LightSwitchRenditionTypes.RenditionCompany",
          interfaces: ["FSharpRecord", "System.IEquatable"],
          properties: {
            CompanyId: "number",
            TaxId: "string",
            ...
            TradeName: "string",
            BusinessPhone: "string",
            StateCodeStablished: "string",
            LoanIndustry: "string",
            NatureOfBusiness: "string",
            LegalStatus: "string",
            RegistrationNumber: "string",
            StateFilingUrl: "string",
            RevenueMoreThanOneMillion: "string",
            IsPhysicalSameAsMailing: "string",
            HasRequestedToApplyJointly: "string",
            DateEstablished: "string",
            ModifiedBy: "string",
            ModifiedOn: "string",
            PhysicalAddress: RenditionUsAddress,
            MailingAddress: RenditionUsAddress,
            DDACollectiveBalance: "string",
            DocRequirementFulfilment: Interface("System.Collections.Generic.IEnumerable")
          }
        };
      }
    ...
    return RenditionCompany;
  }();

  setType("Lr.InTake.Core.LightSwitchRenditionTypes.RenditionCompany", RenditionCompany);

  var CompanyRenditionHelpers = __exports.CompanyRenditionHelpers = function (__exports) {
    var Empty = __exports.Empty = function () {
      var CompanyId = -1;
      var TaxId = "";
      var RegisteredName = "";
      var IsPhysicalSameAsMailing = "";
      var ModifiedBy = "";
      var ModifiedOn = "";
      return new RenditionCompany(CompanyId, TaxId, "", 0, RegisteredName, "", "", "", "", "", "", "", "", "", IsPhysicalSameAsMailing, "", "", ModifiedBy, ModifiedOn, UsAddressRenditionHelpers.Empty, UsAddressRenditionHelpers.Empty, "", new List$1());
    }();

    return __exports;
  }({});

  var RenditionCollateral = __exports.RenditionCollateral = function () {
    function RenditionCollateral(collateralReference, collateralType, collateralTypeName, seqNumber, docRequirementFulfilment) {
      _classCallCheck$3(this, RenditionCollateral);
    ...
    _createClass$3(RenditionCollateral, [{
      key: _Symbol.reflection,
      value: function () {
        return {
          type: "Lr.InTake.Core.LightSwitchRenditionTypes.RenditionCollateral",
          interfaces: ["FSharpRecord", "System.IEquatable"],
          properties: {
    ...
    return RenditionCollateral;
  }();

  setType("Lr.InTake.Core.LightSwitchRenditionTypes.RenditionCollateral", RenditionCollateral);

  var CoreBalance$$1 = __exports.CoreBalance = function () {
    function CoreBalance$$1(acctNumber, currentPrincipalBalance, creditRiskCode, balanceAsOf) {
      _classCallCheck$3(this, CoreBalance$$1);
    ...
    _createClass$3(CoreBalance$$1, [{
      key: _Symbol.reflection,
      value: function () {
        return {
          type: "Lr.InTake.Core.LightSwitchRenditionTypes.CoreBalance",
          interfaces: ["FSharpRecord", "System.IEquatable", "System.IComparable"],
          properties: {
            AcctNumber: "string",
            CurrentPrincipalBalance: "number",
    ...
    return CoreBalance$$1;
  }();

  setType("Lr.InTake.Core.LightSwitchRenditionTypes.CoreBalance", CoreBalance$$1);

  var RenditionLoanRequest = __exports.RenditionLoanRequest = function () {
    function RenditionLoanRequest(requestBaseInfo, requestingCompany, collateral, relatedEntities, lrId, aggregatedBalacesInfo, submittedBy, submittedOn) {
      _classCallCheck$3(this, RenditionLoanRequest);
    ...
    _createClass$3(RenditionLoanRequest, [{
      key: _Symbol.reflection,
      value: function () {
        return {
          type: "Lr.InTake.Core.LightSwitchRenditionTypes.RenditionLoanRequest",
          interfaces: ["FSharpRecord", "System.IEquatable"],
          properties: {
            RequestBaseInfo: RenditionRequestBaseInfo,
            RequestingCompany: RenditionCompany,
            Collateral: Interface("System.Collections.Generic.IEnumerable"),
            RelatedEntities: Interface("System.Collections.Generic.IEnumerable"),
            LrId: "number",
            AggregatedBalacesInfo: CoreAggregatedBalance,
            SubmittedBy: "string",
            SubmittedOn: Date
    ...
    return RenditionLoanRequest;
  }();

  setType("Lr.InTake.Core.LightSwitchRenditionTypes.RenditionLoanRequest", RenditionLoanRequest);

  var RenditionLoanRequestHelpers = __exports.RenditionLoanRequestHelpers = function (__exports) {
    var Empty = __exports.Empty = new RenditionLoanRequest(RequestBaseInfoRenditionHelpers.Empty, CompanyRenditionHelpers.Empty, empty(), empty(), -1, CoreAggregatedBalanceHelpers.Empty, "", now());
    return __exports;
  }({});

  var RenditionLoanRequestBrief = __exports.RenditionLoanRequestBrief = function () {
    function RenditionLoanRequestBrief(companyTaxId, companyName, createdBy, submittedOn, lrId, amountRequested, requestStatus) {
      _classCallCheck$3(this, RenditionLoanRequestBrief);
    ...
    _createClass$3(RenditionLoanRequestBrief, [{
      key: _Symbol.reflection,
      value: function () {
        return {
          type: "Lr.InTake.Core.LightSwitchRenditionTypes.RenditionLoanRequestBrief",
          interfaces: ["FSharpRecord", "System.IEquatable", "System.IComparable"],
          properties: {
            CompanyTaxId: "string",
            CompanyName: "string",
    ...
    return RenditionLoanRequestBrief;
  }();

  setType("Lr.InTake.Core.LightSwitchRenditionTypes.RenditionLoanRequestBrief", RenditionLoanRequestBrief);

  var RenditionLoanRequestBriefHelpers = __exports.RenditionLoanRequestBriefHelpers = function (__exports) {
    var Heading = __exports.Heading = function (model) {
      return String(model.LrId) + " - " + model.CompanyName + " " + model.CompanyTaxId;
    };

    return __exports;
  }({});

  var SubmisionAllowance = __exports.SubmisionAllowance = function () {
    function SubmisionAllowance(isAllowed) {
      _classCallCheck$3(this, SubmisionAllowance);

      this.IsAllowed = isAllowed;
    }

    _createClass$3(SubmisionAllowance, [{
      key: _Symbol.reflection,
      value: function () {
        return {
          type: "Lr.InTake.Core.LightSwitchRenditionTypes.SubmisionAllowance",
          interfaces: ["FSharpRecord", "System.IEquatable", "System.IComparable"],
          properties: {
            IsAllowed: "boolean"
          }
    ...
    return SubmisionAllowance;
  }();

  setType("Lr.InTake.Core.LightSwitchRenditionTypes.SubmisionAllowance", SubmisionAllowance);

  var SubmissionToInTake = __exports.SubmissionToInTake = function () {
    function SubmissionToInTake(submissionId, lrId, username) {
      _classCallCheck$3(this, SubmissionToInTake);
    ...
    _createClass$3(SubmissionToInTake, [{
      key: _Symbol.reflection,
      value: function () {
        return {
          type: "Lr.InTake.Core.LightSwitchRenditionTypes.SubmissionToInTake",
          interfaces: ["FSharpRecord", "System.IEquatable", "System.IComparable"],
          properties: {
            SubmissionId: "number",
            LrId: "number",
    ...
    return SubmissionToInTake;
  }();

  setType("Lr.InTake.Core.LightSwitchRenditionTypes.SubmissionToInTake", SubmissionToInTake);

  var RequestStatus = __exports.RequestStatus = function () {
    function RequestStatus(caseName, fields) {
      _classCallCheck$3(this, RequestStatus);

      this.Case = caseName;
      this.Fields = fields;
    }

    _createClass$3(RequestStatus, [{
      key: _Symbol.reflection,
      value: function () {
        return {
          type: "Lr.InTake.Core.LightSwitchRenditionTypes.RequestStatus",
          interfaces: ["FSharpUnion", "System.IEquatable", "System.IComparable"],
          cases: {
            ApprovedWaitingAcceptance: [],
            Completed: [],
            Denied: [],
            GrayAreaDenial: [],
            GrayAreaMitigantReview: [],
            InProcess: [],
            Incomplete: [],
            SubmittedByOfficer: []
          }
  ...
  setType("Lr.InTake.Core.LightSwitchRenditionTypes.RequestStatus", RequestStatus);

  var RequestStatusHelpers = __exports.RequestStatusHelpers = function (__exports) {
    var Constants = __exports.Constants = function (__exports) {
      var SUBM = __exports.SUBM = "Submitted by Officer";
      var IPRC = __exports.IPRC = "In Process";
      var INCP = __exports.INCP = "Incomplete";
      var DENY = __exports.DENY = "Denied";
      var GRYD = __exports.GRYD = "Gray Area Denial";
      var GRYR = __exports.GRYR = "Gray Area Mitigant(s) Review";
      var APPR = __exports.APPR = "Approved, awaiting acceptance";
      var CMPL = __exports.CMPL = "Completed";
      return __exports;
    }({});

    var ToRendition = __exports.ToRendition = function (s) {
      if (s.Case === "InProcess") {
        return "IPRC";
      } else if (s.Case === "Incomplete") {
        return "INCP";
      } else if (s.Case === "Denied") {
        return "DENY";
      } else if (s.Case === "GrayAreaDenial") {
        return "GRYD";
      } else if (s.Case === "GrayAreaMitigantReview") {
        return "GRYR";
      } else if (s.Case === "ApprovedWaitingAcceptance") {
        return "APPR";
      } else if (s.Case === "Completed") {
        return "CMPL";
      } else {
        return "SUBM";
      }
    ...
    var ToFullDescription = __exports.ToFullDescription = function (s) {
      switch (s) {
        case "SUBM":
          return Constants.SUBM;

        case "IPRC":
          return Constants.IPRC;

        case "INCP":
          return Constants.INCP;

        case "DENY":
          return Constants.DENY;

        case "GRYD":
          return Constants.GRYD;

        case "GRYR":
          return Constants.GRYR;

        case "APPR":
          return Constants.APPR;

        case "CMPL":
          return Constants.CMPL;

        default:
          throw new Error("Unkown Status: " + s);
      }
    };

    var FromRendition = __exports.FromRendition = function (s) {
      switch (s) {
        case "SUBM":
          return new RequestStatus("SubmittedByOfficer", []);

        case "IPRC":
          return new RequestStatus("InProcess", []);

        case "INCP":
          return new RequestStatus("Incomplete", []);

        case "DENY":
          return new RequestStatus("Denied", []);

        case "GRYD":
          return new RequestStatus("GrayAreaDenial", []);

        case "GRYR":
          return new RequestStatus("GrayAreaMitigantReview", []);

        case "APPR":
          return new RequestStatus("ApprovedWaitingAcceptance", []);

        case "CMPL":
          return new RequestStatus("Completed", []);
  ...
  var InTakeQueues = __exports.InTakeQueues = function () {
    function InTakeQueues(submittedByOfficer, inProcess, incomplete, denied, grayAreaDenial, grayAreaMitigantReview, approvedWaitingAcceptance, completed) {
      _classCallCheck$3(this, InTakeQueues);

      this.SubmittedByOfficer = submittedByOfficer;
      this.InProcess = inProcess;
      this.Incomplete = incomplete;
      this.Denied = denied;
      this.GrayAreaDenial = grayAreaDenial;
      this.GrayAreaMitigantReview = grayAreaMitigantReview;
      this.ApprovedWaitingAcceptance = approvedWaitingAcceptance;
      this.Completed = completed;
    }

    _createClass$3(InTakeQueues, [{
      key: _Symbol.reflection,
      value: function () {
        return {
          type: "Lr.InTake.Core.LightSwitchRenditionTypes.InTakeQueues",
          interfaces: ["FSharpRecord", "System.IEquatable"],
          properties: {
            ...
            Denied: Interface("System.Collections.Generic.IEnumerable"),
            GrayAreaDenial: Interface("System.Collections.Generic.IEnumerable"),
            GrayAreaMitigantReview: Interface("System.Collections.Generic.IEnumerable"),
            ApprovedWaitingAcceptance: Interface("System.Collections.Generic.IEnumerable"),
            Completed: Interface("System.Collections.Generic.IEnumerable")
          }
        };
      }
    }, {
  ...
  setType("Lr.InTake.Core.LightSwitchRenditionTypes.InTakeQueues", InTakeQueues);

  var DocContentRequest = __exports.DocContentRequest = function () {
    function DocContentRequest(docId) {
      _classCallCheck$3(this, DocContentRequest);

      this.DocId = docId;
    }

    _createClass$3(DocContentRequest, [{
      key: _Symbol.reflection,
      value: function () {
        return {
          type: "Lr.InTake.Core.LightSwitchRenditionTypes.DocContentRequest",
          interfaces: ["FSharpRecord", "System.IEquatable", "System.IComparable"],
          properties: {
            DocId: "number"
          }
    ...
    return DocContentRequest;
  }();

  setType("Lr.InTake.Core.LightSwitchRenditionTypes.DocContentRequest", DocContentRequest);

  var DocContent = __exports.DocContent = function () {
    function DocContent(docId, contents, referTo, docName, fileExtension) {
      _classCallCheck$3(this, DocContent);
    ...
    _createClass$3(DocContent, [{
      key: _Symbol.reflection,
      value: function () {
        return {
          type: "Lr.InTake.Core.LightSwitchRenditionTypes.DocContent",
          interfaces: ["FSharpRecord", "System.IEquatable", "System.IComparable"],
          properties: {
            DocId: "number",
            Contents: FableArray(Uint8Array, true),
            ReferTo: Option("number"),
            DocName: "string",
  ...
  setType("Lr.InTake.Core.LightSwitchRenditionTypes.DocContent", DocContent);

  var FileSaveRequest = __exports.FileSaveRequest = function () {
    function FileSaveRequest(folderPath, docFileName, docContent) {
      _classCallCheck$3(this, FileSaveRequest);
    ...
    _createClass$3(FileSaveRequest, [{
      key: _Symbol.reflection,
      value: function () {
        return {
          type: "Lr.InTake.Core.LightSwitchRenditionTypes.FileSaveRequest",
          interfaces: ["FSharpRecord", "System.IEquatable", "System.IComparable"],
          properties: {
            FolderPath: "string",
            DocFileName: "string",
  ...
  setType("Lr.InTake.Core.LightSwitchRenditionTypes.FileSaveRequest", FileSaveRequest);

  var GeneralSettings = __exports.GeneralSettings = function () {
    function GeneralSettings(sharedFolderPath) {
      _classCallCheck$3(this, GeneralSettings);

      this.SharedFolderPath = sharedFolderPath;
    }

    _createClass$3(GeneralSettings, [{
      key: _Symbol.reflection,
      value: function () {
        return {
          type: "Lr.InTake.Core.LightSwitchRenditionTypes.GeneralSettings",
          interfaces: ["FSharpRecord", "System.IEquatable", "System.IComparable"],
          properties: {
  ...
  setType("Lr.InTake.Core.LightSwitchRenditionTypes.GeneralSettings", GeneralSettings);
  return __exports;
}({});
...
function parallel(computations) {
    return awaitPromise(Promise.all(map$1(function (w) { return startAsPromise(w); }, computations)));
}
...
var AsyncResult = function () {
  function AsyncResult(caseName, fields) {
    _classCallCheck$7(this, AsyncResult);

    this.Case = caseName;
    this.Fields = fields;
  }

  _createClass$7(AsyncResult, [{
    key: _Symbol.reflection,
    value: function () {
      return {
...
var AsyncExtensions = function (__exports) {
  var AsyncChessie = __exports.AsyncChessie = function (__exports) {
    var singleton$$1 = __exports.singleton = function (value) {
      return function (arg00) {
        return singleton$2.Return(arg00);
      }(value);
    };

    var bind = __exports.bind = function (f, x) {
      return singleton$2.Bind(x, f);
    };

    var map$$1 = __exports.map = function (f, x) {
      return bind(function ($var115) {
        return function (value) {
          return singleton$$1(value);
        }(f($var115));
      }, x);
    };

    var ofAsyncResult = __exports.ofAsyncResult = function (_arg1) {
...
var AsyncTrial = function (__exports) {
  var AsyncTrialBuilder = __exports.AsyncTrialBuilder = function () {
    _createClass$7(AsyncTrialBuilder, [{
      key: _Symbol.reflection,
      value: function () {
        return {
    ...
    function AsyncTrialBuilder() {
      _classCallCheck$7(this, AsyncTrialBuilder);
    }

    _createClass$7(AsyncTrialBuilder, [{
      key: "Return",
      value: function (value) {
        return new AsyncResult("AR", [AsyncExtensions.AsyncChessie.singleton(new Chessie.Result("Ok", [value, new List$1()]))]);
      }
    }, {
      key: "ReturnFrom",
      ...
      value: function (generator) {
        return new AsyncResult("AR", [singleton$2.Delay(function ($var116) {
          return function (arg00_) {
            return AsyncExtensions.AsyncChessie.ofAsyncResult(arg00_);
          }(generator($var116));
        })]);
      }
    }, {
      key: "Bind_0",
      value: function (asyncResult, binder) {
        var fSuccess = function fSuccess(tupledArg) {
          return function ($var120) {
            return function () {
              var f = function f(result) {
                var $var118 = tupledArg[1];
                var $var119 = result;

                if ($var119.Case === "Bad") {
                  return function (errs) {
                    return new Chessie.Result("Bad", [append$$1(errs, $var118)]);
                  }($var119.Fields[0]);
                } else {
                  return function (tupledArg_1) {
                    return new Chessie.Result("Ok", [tupledArg_1[0], append$$1($var118, tupledArg_1[1])]);
                  }([$var119.Fields[0], $var119.Fields[1]]);
                }
              };

              return function (x) {
                return AsyncExtensions.AsyncChessie.map(f, x);
              };
            }()(function ($var117) {
              return function (arg00_) {
                return AsyncExtensions.AsyncChessie.ofAsyncResult(arg00_);
        ...
        var fFailure = function fFailure(errs_1) {
          return AsyncExtensions.AsyncChessie.singleton(new Chessie.Result("Bad", [errs_1]));
        };

        return new AsyncResult("AR", [AsyncExtensions.AsyncChessie.bind(function () {
          var fFailure_1 = fFailure;
          return function (trialResult) {
            var $var121 = trialResult;

            if ($var121.Case === "Bad") {
              return fFailure_1($var121.Fields[0]);
            } else {
              return fSuccess([$var121.Fields[0], $var121.Fields[1]]);
            }
          };
        }(), AsyncExtensions.AsyncChessie.ofAsyncResult(asyncResult))]);
      }
    }, {
      key: "Bind_1",
      value: function (result, binder) {
        return this.Bind_0(new AsyncResult("AR", [AsyncExtensions.AsyncChessie.singleton(result)]), binder);
      }
    }, {
      key: "Bind_2",
      value: function (async, binder) {
        return new AsyncResult("AR", [AsyncExtensions.AsyncChessie.bind(function ($var122) {
          return function (arg00_) {
            return AsyncExtensions.AsyncChessie.ofAsyncResult(arg00_);
          }(binder($var122));
        }, async)]);
      ...
      key: "TryWith",
      value: function (asyncResult, catchHandler) {
        return new AsyncResult("AR", [singleton$2.TryWith(AsyncExtensions.AsyncChessie.ofAsyncResult(asyncResult), function ($var123) {
          return function (arg00_) {
            return AsyncExtensions.AsyncChessie.ofAsyncResult(arg00_);
          }(catchHandler($var123));
        })]);
      ...
      key: "TryFinally",
      value: function (asyncResult, compensation) {
        return new AsyncResult("AR", [singleton$2.TryFinally(AsyncExtensions.AsyncChessie.ofAsyncResult(asyncResult), compensation)]);
      }
    }, {
      key: "Using",
      value: function (resource, binder) {
        return new AsyncResult("AR", [singleton$2.Using(resource, function ($var124) {
          return function (arg00_) {
            return AsyncExtensions.AsyncChessie.ofAsyncResult(arg00_);
          }(binder($var124));
        })]);
    ...
    return AsyncTrialBuilder;
  }();

  setType("Chessie.ErrorHandling.AsyncTrial.AsyncTrialBuilder", AsyncTrialBuilder);
  var asyncTrial = __exports.asyncTrial = new AsyncTrialBuilder();
  return __exports;
}({});
var ParallelValidations = function (__exports) {
  var CollectAllValidated = __exports.CollectAllValidated = function (asyncResults) {
    return function (builder_) {
      return builder_.Delay(function () {
        return builder_.Bind_2(parallel(map$1(function (f) {
          return AsyncExtensions.AsyncChessie.ofAsyncResult(f);
        }, asyncResults)), function (_arg1) {
          return builder_.Bind_1(CommonValidations.CollectAllValidated(_arg1), function (_arg2) {
            return builder_.Return(_arg2);
          });
        });
      });
    }(AsyncTrial.asyncTrial);
  };
...
var BriefsByStatus = function (__exports) {
  var QueryParam = __exports.QueryParam = function () {
    function QueryParam(requestStatus) {
      _classCallCheck$6(this, QueryParam);

      this.RequestStatus = requestStatus;
    }

    _createClass$6(QueryParam, [{
      key: _Symbol.reflection,
      value: function () {
        return {
          type: "Lr.InTake.Core.BriefsQueries.BriefsByStatus.QueryParam",
          interfaces: ["FSharpRecord", "System.IEquatable", "System.IComparable"],
          properties: {
            RequestStatus: LightSwitchRenditionTypes.RequestStatus
          }
        };
      }
    }, {
  ...
  setType("Lr.InTake.Core.BriefsQueries.BriefsByStatus.QueryParam", QueryParam);
  return __exports;
}({});
var BriefsForInTake = function (__exports) {
  var QueryServices = __exports.QueryServices = function () {
    function QueryServices(briefsByStatus) {
      _classCallCheck$6(this, QueryServices);

      this.briefsByStatus = briefsByStatus;
    }

    _createClass$6(QueryServices, [{
      key: _Symbol.reflection,
      value: function () {
        return {
          type: "Lr.InTake.Core.BriefsQueries.BriefsForInTake.QueryServices",
          interfaces: ["FSharpRecord"],
          properties: {
            briefsByStatus: "function"
          }
        };
      }
    }]);
  ...
  setType("Lr.InTake.Core.BriefsQueries.BriefsForInTake.QueryServices", QueryServices);
  var EmptyQueryResultModel = __exports.EmptyQueryResultModel = new LightSwitchRenditionTypes.InTakeQueues(new List$1(), new List$1(), new List$1(), new List$1(), new List$1(), new List$1(), new List$1(), new List$1());

  var Query = __exports.Query = function (services) {
    var qry = function qry() {
      return function (builder_) {
        return builder_.Delay(function () {
          return builder_.Bind_0(services.briefsByStatus(new BriefsByStatus.QueryParam(new LightSwitchRenditionTypes.RequestStatus("SubmittedByOfficer", []))), function (_arg1) {
            return builder_.Bind_0(services.briefsByStatus(new BriefsByStatus.QueryParam(new LightSwitchRenditionTypes.RequestStatus("InProcess", []))), function (_arg2) {
              return builder_.Bind_0(services.briefsByStatus(new BriefsByStatus.QueryParam(new LightSwitchRenditionTypes.RequestStatus("Incomplete", []))), function (_arg3) {
                return builder_.Bind_0(services.briefsByStatus(new BriefsByStatus.QueryParam(new LightSwitchRenditionTypes.RequestStatus("Denied", []))), function (_arg4) {
                  return builder_.Bind_0(services.briefsByStatus(new BriefsByStatus.QueryParam(new LightSwitchRenditionTypes.RequestStatus("GrayAreaDenial", []))), function (_arg5) {
                    return builder_.Bind_0(services.briefsByStatus(new BriefsByStatus.QueryParam(new LightSwitchRenditionTypes.RequestStatus("GrayAreaMitigantReview", []))), function (_arg6) {
                      return builder_.Bind_0(services.briefsByStatus(new BriefsByStatus.QueryParam(new LightSwitchRenditionTypes.RequestStatus("ApprovedWaitingAcceptance", []))), function (_arg7) {
                        return builder_.Bind_0(services.briefsByStatus(new BriefsByStatus.QueryParam(new LightSwitchRenditionTypes.RequestStatus("Completed", []))), function (_arg8) {
                          var goodObj = new LightSwitchRenditionTypes.InTakeQueues(_arg1, _arg2, _arg3, _arg4, _arg5, _arg6, _arg7, _arg8);
                          return builder_.Return(goodObj);
                        });
                      });
                    });
                  });
...
var Result = function () {
    function Result(caseName, fields) {
        _classCallCheck$9(this, Result);

        this.Case = caseName;
        this.Fields = fields;
    }

    _createClass$9(Result, [{
        key: _Symbol.reflection,
        value: function () {
            return {
...
var ResultBuilder = function () {
    ...
    function ResultBuilder() {
        _classCallCheck$9(this, ResultBuilder);
    }
...
var _Promise = function (__exports) {
    ...
    var PromiseBuilder = __exports.PromiseBuilder = function () {
        ...
        function PromiseBuilder() {
            _classCallCheck$8(this, PromiseBuilder);
        }
...
var Msg = function () {
  ...
  _createClass(Msg, [{
    ...
    value: function () {
      return {
        type: "Lr.InTake.View.BriefsQueueViewModel.Msg",
        interfaces: ["FSharpUnion", "System.IEquatable"],
        cases: {
          LoadRecord: [Unit],
          ...
          RecordLoaded: [makeGeneric(Chessie.Result, {
            TSuccess: LightSwitchRenditionTypes.InTakeQueues,
            TMessage: Interface("System.Collections.Generic.IEnumerable")
          })],
          ResetNeedsRefresh: ["boolean"]
        }
      };
    }
  }, {
...
setType("Lr.InTake.View.BriefsQueueViewModel.Msg", Msg);
var ScreenType = function () {
  function ScreenType(queryModel, currentErrors, needsRefresh) {
  ...
  _createClass(ScreenType, [{
    ...
    value: function () {
      return {
        type: "Lr.InTake.View.BriefsQueueViewModel.ScreenType",
        interfaces: ["FSharpRecord", "System.IEquatable"],
        properties: {
          QueryModel: LightSwitchRenditionTypes.InTakeQueues,
...
setType("Lr.InTake.View.BriefsQueueViewModel.ScreenType", ScreenType);
var EmptyScreen = new ScreenType(BriefsForInTake.EmptyQueryResultModel, new List$1(), true);

var getRecord = function () {
  var url = "/api/BriefsQueue/BriefsForInTake";
  ...
  return function () {
    return function (handler) {
      goGet(url, msgOnSuccess, msgOnFailure, null, handler, {
        ReturnedEntityType: makeGeneric(Chessie.Result, {
          TSuccess: LightSwitchRenditionTypes.InTakeQueues,
          TMessage: Interface("System.Collections.Generic.IEnumerable")
        }),
        MsgType: Msg
...
var _classCallCheck$10 = unwrapExports(classCallCheck);
...
var _createClass$10 = unwrapExports(createClass);
...
var Program = function () {
    function Program(init, update, subscribe, view, setState, onError) {
        _classCallCheck$10(this, Program);
...
var Components = function (__exports) {
    var LazyView = __exports.LazyView = function (_Component) {
        ...
        function LazyView(props) {
            _classCallCheck$10(this, LazyView);
...
function RefreshOnTimeout(msgSender) {
  window.setTimeout(function () {
    return msgSender(new Msg("ResetNeedsRefresh", [true]));
  }, 1000 * 60 * 3);
  return msgSender(new Msg("ResetNeedsRefresh", [false]));
}
function formatDate(dt) {
  return toString(dt).substr(0, 10);
}
function viewQueueItem(item$$1) {
  var itemUrl = "/public/?screen=EditQueuedRequest&recordId=" + String(item$$1.LrId);
  var now$$1 = now();

  var AddStarIfNew = function AddStarIfNew(model) {
  ...
  }, LightSwitchRenditionTypes.RenditionLoanRequestBriefHelpers.Heading(item$$1))), react.createElement("div", {
    className: "panel-body"
  }, react.createElement("div", {}, item$$1.CreatedBy), react.createElement("div", {}, AddStarIfNew(item$$1), react.createElement("span", {}, formatDate(item$$1.SubmittedOn))), react.createElement("div", {}, item$$1.AmountRequested), react.createElement("a", {
    className: "btn btn-primary",
    role: "button",
    href: itemUrl
  }, "Edit")));
}
function viewQueue(headerTxt, queue) {
  var className = replace$$1(toString(headerTxt), " ", "-") + "-queue-container queue-container";
  return react.createElement("div", {
    className: "col-md-1"
  }, react.createElement("h4", {}, headerTxt), react.createElement.apply(undefined, ["div", {
    className: className
...
function View(screen, msgSender) {
  if (screen.NeedsRefresh) {
    RefreshOnTimeout(msgSender);
  }

  return react.createElement("div", {
    className: "briefs-queue-screen row"
  }, viewQueue(LightSwitchRenditionTypes.RequestStatusHelpers.Constants.SUBM, screen.QueryModel.SubmittedByOfficer), viewQueue(LightSwitchRenditionTypes.RequestStatusHelpers.Constants.IPRC, screen.QueryModel.InProcess), viewQueue(LightSwitchRenditionTypes.RequestStatusHelpers.Constants.INCP, screen.QueryModel.Incomplete), viewQueue(LightSwitchRenditionTypes.RequestStatusHelpers.Constants.DENY, screen.QueryModel.Denied), viewQueue(LightSwitchRenditionTypes.RequestStatusHelpers.Constants.GRYD, screen.QueryModel.GrayAreaDenial), viewQueue(LightSwitchRenditionTypes.RequestStatusHelpers.Constants.GRYR, screen.QueryModel.GrayAreaMitigantReview), viewQueue(LightSwitchRenditionTypes.RequestStatusHelpers.Constants.APPR, screen.QueryModel.ApprovedWaitingAcceptance), viewQueue(LightSwitchRenditionTypes.RequestStatusHelpers.Constants.CMPL, screen.QueryModel.Completed));
}
function MainView(screen, msgSender) {
  return Common.lazyView2(function (screen_1) {
    return function (msgSender_1) {
      return View(screen_1, msgSender_1);
    };
  })(screen)(msgSender);
}
  ...
  if (appMsg.Case === "RecordLoaded") {
    if (appMsg.Fields[0].Case === "Bad") {
      return [function () {
        ...
        return new ScreenType(screen.QueryModel, CurrentErrors, screen.NeedsRefresh);
      }(), new List$1()];
    } else {
      return [new ScreenType(appMsg.Fields[0].Fields[0], screen.CurrentErrors, screen.NeedsRefresh), new List$1()];
    }
  } else if (appMsg.Case === "RecordFailedToLoad") {
    return [function () {
      var CurrentErrors_1 = ofArray([appMsg.Fields[0]]);
      return new ScreenType(screen.QueryModel, CurrentErrors_1, screen.NeedsRefresh);
    }(), new List$1()];
  } else if (appMsg.Case === "OpenLoanRequest") {
    return [screen, new List$1()];
  } else if (appMsg.Case === "ResetNeedsRefresh") {
    if (appMsg.Fields[0]) {
      return [function () {
        var NeedsRefresh = true;
        return new ScreenType(screen.QueryModel, screen.CurrentErrors, NeedsRefresh);
      }(), ofArray([Load()])];
    } else {
      return [function () {
        var NeedsRefresh_1 = false;
        return new ScreenType(screen.QueryModel, screen.CurrentErrors, NeedsRefresh_1);
      }(), new List$1()];
    }
  } else {
    return [screen, ofArray([Load()])];
  }
}
var emptyModel = EmptyScreen;
function init() {
  return [emptyModel, ofArray([Load()])];
}
...
function RunScreen(divId, qryParams) {
  ...
  ProgramModule.run(function (program) {
    ...
    return function (msgSender) {
      return MainView(screen_1, msgSender);
    };
  })));
}
...
var QueryRequestType = function () {
  function QueryRequestType(id, collateralId, docRequirementId, username) {
    _classCallCheck$12(this, QueryRequestType);
  ...
  _createClass$12(QueryRequestType, [{
    key: _Symbol.reflection,
    value: function () {
      return {
...
setType("Lr.Core.UpdateCollateralDocScreen.QueryType", QueryType);
var CmdType = function () {
  function CmdType(collateralDocument, modifiedOn, modifiedBy) {
    _classCallCheck$12(this, CmdType);
...
var EmptyQuery = new QueryType(Empty$1, [], "", "");
...
var ScreenType$1 = function () {
  function ScreenType(queryModel, currentErrors) {
    _classCallCheck$11(this, ScreenType);

    this.QueryModel = queryModel;
    this.CurrentErrors = currentErrors;
  }

  _createClass$11(ScreenType, [{
    key: _Symbol.reflection,
    value: function () {
      return {
...
var EmptyScreen$1 = new ScreenType$1(EmptyQuery, new List$1());
...
function InitQueryRequest$1(recordId, colId, requirementId) {
  return new QueryRequestType(recordId, colId, requirementId, "Unkown");
}
...
var ReactHelpers = function (__exports) {
  ...
  var classNames = __exports.classNames = function ($var194) {
  ...
  var onBtnClick = __exports.onBtnClick = function (msg, dispatch, mouseEvt) {
    return dispatch(msg);
  };

  var handleInputChg = __exports.handleInputChg = function (dispatch, msg) {
    return function ($var197) {
      return dispatch(function ($var196) {
        return msg(function ($var195) {
          return function (value) {
            return value;
          }(function (ev) {
  ...
  var handleToolboxInputChg = __exports.handleToolboxInputChg = function (dispatch, msg) {
    return function ($var200) {
      return dispatch(function ($var199) {
        return msg(function ($var198) {
          return function (value) {
            return value;
          }(function (strVal) {
            return strVal;
  ...
  var handleToolboxAutoCompleteChg = __exports.handleToolboxAutoCompleteChg = function (dispatch, msg) {
    return function ($var203) {
      return dispatch(function ($var202) {
        return msg(function ($var201) {
          return function (value) {
            return value;
          }(function (strVal) {
            return strVal;
  ...
  var handleToolboxDateChg = __exports.handleToolboxDateChg = function (dispatch, msg) {
    return function ($var206) {
      return dispatch(function ($var205) {
        return msg(function ($var204) {
          return function (value) {
            return value;
          }(function (dateVal) {
            return dateVal;
  ...
  var CreateTable = __exports.CreateTable = function (headers, rows) {
    var allItems = toList(map$1(function (r) {
      var cols = map$$1(function (c) {
        return react.createElement("td", {}, c);
      }, r);
      return react.createElement.apply(undefined, ["tr", {}].concat(_toConsumableArray$1(cols)));
    }, rows));
    return react.createElement("table", {
      className: "appTable"
    }, react.createElement("thead", {}, react.createElement.apply(undefined, ["tr", {}].concat(_toConsumableArray$1(map$$1(function (c_1) {
      return react.createElement("th", {}, c_1);
    }, headers))))), react.createElement.apply(undefined, ["tbody", {}].concat(_toConsumableArray$1(allItems))));
  };

  var Header = __exports.Header = function (headerTxt) {
    return react.createElement("h2", {}, headerTxt);
  };

  var Header3 = __exports.Header3 = function (headerTxt) {
    return react.createElement("h3", {}, headerTxt);
  };

  var Header4 = __exports.Header4 = function (headerTxt) {
    return react.createElement("h4", {}, headerTxt);
  };

  var Col = __exports.Col = function (elements) {
    return react.createElement.apply(undefined, ["div", {
      className: "col"
    }].concat(_toConsumableArray$1(elements)));
  };

  var Group = __exports.Group = function (elements) {
    return react.createElement.apply(undefined, ["div", {
      className: "group"
    }].concat(_toConsumableArray$1(elements)));
  };
  ...
  var ejUploadboxSuccessEvent = __exports.ejUploadboxSuccessEvent = function () {
    function ejUploadboxSuccessEvent(responseText, success) {
      _classCallCheck$13(this, ejUploadboxSuccessEvent);

      this.responseText = responseText;
      this.success = success;
    }

    _createClass$13(ejUploadboxSuccessEvent, [{
      key: _Symbol.reflection,
      value: function () {
        return {
  ...
  var ejEvent = __exports.ejEvent = function () {
    function ejEvent(value) {
      _classCallCheck$13(this, ejEvent);

      this.value = value;
    }

    _createClass$13(ejEvent, [{
      key: _Symbol.reflection,
      value: function () {
        return {
  ...
  var EJAutocompleteOption = __exports.EJAutocompleteOption = function () {
    function EJAutocompleteOption(name, index) {
      _classCallCheck$13(this, EJAutocompleteOption);

      this.name = name;
      this.index = index;
    }

    _createClass$13(EJAutocompleteOption, [{
      key: _Symbol.reflection,
      value: function () {
        return {
  ...
  var EJColumn = __exports.EJColumn = function () {
    function EJColumn(field, headerText, width, textAlign) {
      _classCallCheck$13(this, EJColumn);
    ...
    _createClass$13(EJColumn, [{
      key: _Symbol.reflection,
      value: function () {
        return {
          type: "FsCommons.Presentation.ReactHelpers.EJColumn",
          interfaces: ["FSharpRecord", "System.IEquatable", "System.IComparable"],
          properties: {
            field: "string",
            headerText: "string",
  ...
  setType("FsCommons.Presentation.ReactHelpers.EJColumn", EJColumn);

  var EJDropDownOption = __exports.EJDropDownOption = function () {
    function EJDropDownOption(text, value) {
      _classCallCheck$13(this, EJDropDownOption);

      this.text = text;
      this.value = value;
    }

    _createClass$13(EJDropDownOption, [{
      key: _Symbol.reflection,
      value: function () {
        return {
          type: "FsCommons.Presentation.ReactHelpers.EJDropDownOption",
          interfaces: ["FSharpRecord", "System.IEquatable", "System.IComparable"],
          properties: {
            text: "string",
            value: "string"
    ...
    return EJDropDownOption;
  }();

  setType("FsCommons.Presentation.ReactHelpers.EJDropDownOption", EJDropDownOption);
  ...
  var TextField = __exports.TextField = function (label, value, msgToSend, msgSender) {
    return react.createElement("div", {
      className: "form-group"
      ...
      onChange: handleInputChg(msgSender, msgToSend),
      type: "text",
      value: value
    }));
  };

  var DropDownFieldStr = __exports.DropDownFieldStr = function (possibleValues, msgToSend, label, value, msgSender) {
    var ejChoices = possibleValues.map(function (tupledArg) {
      return new EJDropDownOption(toString(tupledArg[1]), tupledArg[0]);
    });
    return react.createElement("div", {
      className: "form-group"
    }, react.createElement("label", {}, label), React.createElement(EJ.DropDownList, {
      change: function change(newVal) {
        raiseInputChg(msgSender, msgToSend, newVal);
      },
      value: value,
  ...
  var AutocompleteChoicesFieldStr = __exports.AutocompleteChoicesFieldStr = function (possibleValues, msgToSend, label, value, msgSender) {
    var ejChoices = possibleValues.map(function (tupledArg) {
      return new EJAutocompleteOption(toString(tupledArg[1]), tupledArg[0]);
    });
    return react.createElement("div", {
      className: "form-group"
...
function getParamValue$1(qryParams, paramName) {
  return function (option) {
    return defaultArg(option, null, ConversionHelpers.tryParseInt);
  }(defaultArg(tryFind(function (tupledArg) {
...
function RunScreen$1(divId, qryParams) {
  ...
  var $var281 = matchValue[0] != null ? matchValue[0] != null ? matchValue[1] != null ? matchValue[1] != null ? matchValue[2] != null ? matchValue[2] != null ? [0, matchValue[1], matchValue[0], matchValue[2]] : [1] : [1] : [1] : [1] : [1] : [1];

  switch ($var281[0]) {
    case 0:
      var paramQry = InitQueryRequest$1($var281[2], $var281[1], $var281[3]);
      ProgramModule.run(function (program) {
        return withReact(divId, program);
      }(ProgramModule.mkProgram(function () {
...
var RenditionRequestBaseInfoByLoanReqIdParam = function () {
  function RenditionRequestBaseInfoByLoanReqIdParam(lrId) {
    _classCallCheck$16(this, RenditionRequestBaseInfoByLoanReqIdParam);

    this.LrId = lrId;
  }

  _createClass$16(RenditionRequestBaseInfoByLoanReqIdParam, [{
    key: _Symbol.reflection,
    value: function () {
      return {
        type: "Lr.InTake.Core.RenditionRequestBaseInfoQueries.RenditionRequestBaseInfoByLoanReqIdParam",
        interfaces: ["FSharpRecord", "System.IEquatable", "System.IComparable"],
        properties: {
          LrId: "number"
        }
  ...
  return RenditionRequestBaseInfoByLoanReqIdParam;
}();
setType("Lr.InTake.Core.RenditionRequestBaseInfoQueries.RenditionRequestBaseInfoByLoanReqIdParam", RenditionRequestBaseInfoByLoanReqIdParam);
...
var RenditionCompanyByLoanReqIdParam = function () {
  function RenditionCompanyByLoanReqIdParam(lrId) {
    _classCallCheck$17(this, RenditionCompanyByLoanReqIdParam);

    this.LrId = lrId;
  }

  _createClass$17(RenditionCompanyByLoanReqIdParam, [{
    key: _Symbol.reflection,
    value: function () {
      return {
        type: "Lr.InTake.Core.RenditionCompanyQueries.RenditionCompanyByLoanReqIdParam",
        interfaces: ["FSharpRecord", "System.IEquatable", "System.IComparable"],
        properties: {
          LrId: "number"
        }
  ...
  return RenditionCompanyByLoanReqIdParam;
}();
setType("Lr.InTake.Core.RenditionCompanyQueries.RenditionCompanyByLoanReqIdParam", RenditionCompanyByLoanReqIdParam);
...
var RenditionCollateralByLoanReqIdParam = function () {
  function RenditionCollateralByLoanReqIdParam(lrId) {
    _classCallCheck$18(this, RenditionCollateralByLoanReqIdParam);

    this.LrId = lrId;
  }

  _createClass$18(RenditionCollateralByLoanReqIdParam, [{
    key: _Symbol.reflection,
    value: function () {
      return {
        type: "Lr.InTake.Core.RenditionCollateralQueries.RenditionCollateralByLoanReqIdParam",
        interfaces: ["FSharpRecord", "System.IEquatable", "System.IComparable"],
        properties: {
          LrId: "number"
        }
  ...
  return RenditionCollateralByLoanReqIdParam;
}();
setType("Lr.InTake.Core.RenditionCollateralQueries.RenditionCollateralByLoanReqIdParam", RenditionCollateralByLoanReqIdParam);
...
var RenditionRelatedEntityByLoanReqIdParam = function () {
  function RenditionRelatedEntityByLoanReqIdParam(lrId) {
    _classCallCheck$19(this, RenditionRelatedEntityByLoanReqIdParam);

    this.LrId = lrId;
  }

  _createClass$19(RenditionRelatedEntityByLoanReqIdParam, [{
    key: _Symbol.reflection,
    value: function () {
      return {
        type: "Lr.InTake.Core.RenditionRelatedEntityQueries.RenditionRelatedEntityByLoanReqIdParam",
        interfaces: ["FSharpRecord", "System.IEquatable", "System.IComparable"],
        properties: {
          LrId: "number"
        }
  ...
  return RenditionRelatedEntityByLoanReqIdParam;
}();
setType("Lr.InTake.Core.RenditionRelatedEntityQueries.RenditionRelatedEntityByLoanReqIdParam", RenditionRelatedEntityByLoanReqIdParam);
...
var InQueueById = function (__exports) {
  var QueryParam = __exports.QueryParam = function () {
    function QueryParam(lrId) {
      _classCallCheck$15(this, QueryParam);

      this.LrId = lrId;
    }

    _createClass$15(QueryParam, [{
      key: _Symbol.reflection,
      value: function () {
        return {
          type: "Lr.InTake.Core.RenditionLoanRequestQueries.InQueueById.QueryParam",
          interfaces: ["FSharpRecord", "System.IEquatable", "System.IComparable"],
          properties: {
            LrId: "number"
          }
  ...
  setType("Lr.InTake.Core.RenditionLoanRequestQueries.InQueueById.QueryParam", QueryParam);
  var EmptyQueryResultModel = __exports.EmptyQueryResultModel = LightSwitchRenditionTypes.RenditionLoanRequestHelpers.Empty;
  return __exports;
}({});
var ByLoanReqId = function (__exports) {
  var QueryParam = __exports.QueryParam = function () {
    function QueryParam(lrId) {
      _classCallCheck$15(this, QueryParam);
    ...
    _createClass$15(QueryParam, [{
      ...
      value: function () {
        return {
          type: "Lr.InTake.Core.RenditionLoanRequestQueries.ByLoanReqId.QueryParam",
          interfaces: ["FSharpRecord", "System.IEquatable", "System.IComparable"],
          properties: {
            LrId: "number"
          }
  ...
  setType("Lr.InTake.Core.RenditionLoanRequestQueries.ByLoanReqId.QueryParam", QueryParam);

  var QueryServices = __exports.QueryServices = function () {
    function QueryServices(baseInfoQuery, companyQuery, entQuery, collateralQuery, balancesQuery) {
      _classCallCheck$15(this, QueryServices);

      this.baseInfoQuery = baseInfoQuery;
      this.companyQuery = companyQuery;
      this.entQuery = entQuery;
      this.collateralQuery = collateralQuery;
      this.balancesQuery = balancesQuery;
    }

    _createClass$15(QueryServices, [{
      key: _Symbol.reflection,
      value: function () {
        return {
          type: "Lr.InTake.Core.RenditionLoanRequestQueries.ByLoanReqId.QueryServices",
          interfaces: ["FSharpRecord"],
          properties: {
            baseInfoQuery: "function",
            companyQuery: "function",
            entQuery: "function",
            collateralQuery: "function",
            balancesQuery: "function"
          }
        };
      }
    }]);
  ...
  setType("Lr.InTake.Core.RenditionLoanRequestQueries.ByLoanReqId.QueryServices", QueryServices);

  var Query = __exports.Query = function (services, qryParam) {
    return function (builder_) {
      return builder_.Delay(function () {
        return builder_.Bind_0(services.baseInfoQuery(new RenditionRequestBaseInfoByLoanReqIdParam(qryParam.LrId)), function (_arg1) {
          return builder_.Bind_0(services.companyQuery(new RenditionCompanyByLoanReqIdParam(qryParam.LrId)), function (_arg2) {
            return builder_.Bind_0(services.collateralQuery(new RenditionCollateralByLoanReqIdParam(qryParam.LrId)), function (_arg3) {
              return builder_.Bind_0(services.entQuery(new RenditionRelatedEntityByLoanReqIdParam(qryParam.LrId)), function (_arg4) {
                return builder_.Bind_1(CommonValidations.MustBeSome("Company", _arg2), function (_arg5) {
                  return builder_.Bind_1(CommonValidations.MustBeSome("Loan Request Base Info", _arg1), function (_arg6) {
                    return builder_.Bind_0(services.balancesQuery(new CoreBalanceRequest(_arg5.TaxId, _arg6.AmountRequested)), function (_arg7) {
                      var loanReq = new LightSwitchRenditionTypes.RenditionLoanRequest(_arg6, _arg5, _arg3, _arg4, qryParam.LrId, _arg7, "", now());
                      return builder_.Return(loanReq);
                    });
                  });
                });
              });
...
var InTakeStatusChange = function () {
  function InTakeStatusChange(lrId, newStatus, username, reasons) {
    _classCallCheck$20(this, InTakeStatusChange);
  ...
  _createClass$20(InTakeStatusChange, [{
    key: _Symbol.reflection,
    value: function () {
      return {
        type: "Lr.InTake.Core.CommandTypes.InTakeStatusChange",
        interfaces: ["FSharpRecord", "System.IEquatable"],
        properties: {
          LrId: makeGeneric(BzProp, {
            P: PositiveInt,
            RawType: "string"
          }),
          NewStatus: LightSwitchRenditionTypes.RequestStatus,
          Username: "string",
          Reasons: FableArray("string")
        }
      };
    }
  }, {
  ...
  return InTakeStatusChange;
}();
setType("Lr.InTake.Core.CommandTypes.InTakeStatusChange", InTakeStatusChange);
var InTakeStatusChangeHelpers = function (__exports) {
  var UpdateReason = __exports.UpdateReason = function (model, idxChanged, reasonTxt) {
    var newReasons = mapIndexed$1(function (idx, r) {
      return idx === idxChanged ? reasonTxt : r;
    }, model.Reasons);
    var areAllReasonsFull = tryFind(function (r_1) {
      return r_1 === "";
    }, newReasons) == null;
    var updatedReasons = areAllReasonsFull ? append$1(newReasons, ofArray([""])) : newReasons;
    var Reasons = Array.from(updatedReasons);
    return new InTakeStatusChange(model.LrId, model.NewStatus, model.Username, Reasons);
  };

  return __exports;
}({});
var RenditionInTakeStatusChangeHelpers = function (__exports) {
  var RenditionInTakeStatusChange = __exports.RenditionInTakeStatusChange = function () {
    function RenditionInTakeStatusChange(statusChangeId, lrId, newStatus, username, reasons) {
      _classCallCheck$20(this, RenditionInTakeStatusChange);
    ...
    _createClass$20(RenditionInTakeStatusChange, [{
      key: _Symbol.reflection,
      value: function () {
        return {
          type: "Lr.InTake.Core.CommandTypes.RenditionInTakeStatusChangeHelpers.RenditionInTakeStatusChange",
          interfaces: ["FSharpRecord", "System.IEquatable"],
          properties: {
            ...
            NewStatus: "string",
            Username: "string",
            Reasons: Interface("System.Collections.Generic.IEnumerable")
          }
        };
      }
    }, {
    ...
    return RenditionInTakeStatusChange;
  }();

  setType("Lr.InTake.Core.CommandTypes.RenditionInTakeStatusChangeHelpers.RenditionInTakeStatusChange", RenditionInTakeStatusChange);

  var Empty = __exports.Empty = function () {
    var StatusChangeId = -1;
    var LrId = "-1";
    var NewStatus = "";
    var Reasons = empty();
    return new RenditionInTakeStatusChange(StatusChangeId, LrId, NewStatus, "", Reasons);
  }();

  var FromRendition = __exports.FromRendition = function (rend) {
    return new InTakeStatusChange(PositiveInt.FromRendition(rend.LrId), LightSwitchRenditionTypes.RequestStatusHelpers.FromRendition(rend.NewStatus), rend.Username, Array.from(rend.Reasons));
  };

  var ToRendition = __exports.ToRendition = function (bzObj) {
    return new RenditionInTakeStatusChange(-1, BzPropToRendtion(bzObj.LrId), LightSwitchRenditionTypes.RequestStatusHelpers.ToRendition(bzObj.NewStatus), bzObj.Username, bzObj.Reasons);
  };

  var ToNotificationSubject = __exports.ToNotificationSubject = function (model) {
    var newStatus = LightSwitchRenditionTypes.RequestStatusHelpers.ToFullDescription(model.NewStatus);
    var body = fsFormat("Loan Request # %s was changed to \"%s\"")(function (x) {
      return x;
    })(model.LrId)(newStatus);
    return body;
  };

  var ToNotification = __exports.ToNotification = function (model) {
    var newStatus = LightSwitchRenditionTypes.RequestStatusHelpers.ToFullDescription(model.NewStatus);
    var allReasons = "<ol>" + join(" ", map$1(function (r) {
      return "<li>" + r + "</li>";
    }, model.Reasons)) + "</ol>";
    var body = fsFormat("<p>The Loan Request # %s was marked as %s with the following notes: </p> %s ")(function (x) {
      return x;
    })(model.LrId)(newStatus)(allReasons);
    return body;
  };

  var CleanReasons = __exports.CleanReasons = function (model) {
    var Reasons = filter$1(function (r) {
      return r !== "";
    }, model.Reasons);
    return new RenditionInTakeStatusChange(model.StatusChangeId, model.LrId, model.NewStatus, model.Username, Reasons);
  };

  var RenditionInTakeStatusChangeSnapshot = __exports.RenditionInTakeStatusChangeSnapshot = function () {
    function RenditionInTakeStatusChangeSnapshot(statusChangeSnapshot, loanRequestSnapshot) {
      _classCallCheck$20(this, RenditionInTakeStatusChangeSnapshot);

      this.StatusChangeSnapshot = statusChangeSnapshot;
      this.LoanRequestSnapshot = loanRequestSnapshot;
    }

    _createClass$20(RenditionInTakeStatusChangeSnapshot, [{
      key: _Symbol.reflection,
      value: function () {
        return {
          type: "Lr.InTake.Core.CommandTypes.RenditionInTakeStatusChangeHelpers.RenditionInTakeStatusChangeSnapshot",
          interfaces: ["FSharpRecord", "System.IEquatable"],
          properties: {
            StatusChangeSnapshot: RenditionInTakeStatusChange,
            LoanRequestSnapshot: LightSwitchRenditionTypes.RenditionLoanRequest
          }
        };
      }
    }, {
    ...
    return RenditionInTakeStatusChangeSnapshot;
  }();

  setType("Lr.InTake.Core.CommandTypes.RenditionInTakeStatusChangeHelpers.RenditionInTakeStatusChangeSnapshot", RenditionInTakeStatusChangeSnapshot);
  return __exports;
}({});
var ValidatedInTakeStatusChangeHelpers = function (__exports) {
  var ValidatedInTakeStatusChange = __exports.ValidatedInTakeStatusChange = function () {
    function ValidatedInTakeStatusChange(lrId, newStatus, username, reasons) {
      _classCallCheck$20(this, ValidatedInTakeStatusChange);
    ...
    _createClass$20(ValidatedInTakeStatusChange, [{
      key: _Symbol.reflection,
      value: function () {
        return {
          type: "Lr.InTake.Core.CommandTypes.ValidatedInTakeStatusChangeHelpers.ValidatedInTakeStatusChange",
          interfaces: ["FSharpRecord", "System.IEquatable"],
          properties: {
            LrId: PositiveInt,
            NewStatus: LightSwitchRenditionTypes.RequestStatus,
    ...
    return ValidatedInTakeStatusChange;
  }();

  setType("Lr.InTake.Core.CommandTypes.ValidatedInTakeStatusChangeHelpers.ValidatedInTakeStatusChange", ValidatedInTakeStatusChange);

  var FromRendition = __exports.FromRendition = function (rend) {
    return function (builder_) {
      return builder_.Run(builder_.Delay(function () {
        return builder_.Bind(BzPropToResult(PositiveInt.FromRendition(rend.LrId)), function (_arg1) {
          return builder_.Bind(BzPropToResult(function (arg00) {
            return function (arg10) {
              return LongName.Create(arg00, arg10);
            };
          }("Username")(rend.Username)), function (_arg2) {
            return builder_.Return(new ValidatedInTakeStatusChange(_arg1, LightSwitchRenditionTypes.RequestStatusHelpers.FromRendition(rend.NewStatus), _arg2, rend.Reasons));
          });
        });
      }));
    }(Chessie.Trial.trial);
...
var Msg$2 = function () {
  ...
  _createClass$14(Msg, [{
    ...
    value: function () {
      return {
        type: "Lr.InTake.View.EditQueuedRequestViewModel.Msg",
        interfaces: ["FSharpUnion", "System.IEquatable"],
        cases: {
          LoadRecord: [InQueueById.QueryParam],
          NewStatus: ["string"],
          Reason: [Tuple(["number", "string"])],
          RecordFailedToLoad: [PropertyError],
          RecordFailedToSave: [PropertyError],
          RecordLoaded: [makeGeneric(Chessie.Result, {
            TSuccess: LightSwitchRenditionTypes.RenditionLoanRequest,
            TMessage: Interface("System.Collections.Generic.IEnumerable")
          })],
          RecordSaved: [makeGeneric(Chessie.Result, {
            TSuccess: RenditionInTakeStatusChangeHelpers.RenditionInTakeStatusChange,
            TMessage: Interface("System.Collections.Generic.IEnumerable")
          })],
          SaveRecord: []
        }
...
setType("Lr.InTake.View.EditQueuedRequestViewModel.Msg", Msg$2);
var ScreenType$2 = function () {
  function ScreenType(queryModel, editModel, currentErrors, canSave) {
    _classCallCheck$14(this, ScreenType);
  ...
  _createClass$14(ScreenType, [{
    key: _Symbol.reflection,
    value: function () {
      return {
        type: "Lr.InTake.View.EditQueuedRequestViewModel.ScreenType",
        interfaces: ["FSharpRecord", "System.IEquatable"],
        properties: {
          QueryModel: LightSwitchRenditionTypes.RenditionLoanRequest,
          EditModel: InTakeStatusChange,
          CurrentErrors: Interface("System.Collections.Generic.IEnumerable"),
          CanSave: "boolean"
        }
      };
...
setType("Lr.InTake.View.EditQueuedRequestViewModel.ScreenType", ScreenType$2);
var EmptyScreen$2 = function () {
  var CurrentErrors = new List$1();
  return new ScreenType$2(InQueueById.EmptyQueryResultModel, RenditionInTakeStatusChangeHelpers.FromRendition(RenditionInTakeStatusChangeHelpers.Empty), CurrentErrors, false);
}();

var getRecord$2 = function () {
  var url = "/api/InTakeQueue/InQueueById";

  var msgOnSuccess = function msgOnSuccess(arg0) {
    return new Msg$2("RecordLoaded", [arg0]);
  };

  var msgOnFailure = function msgOnFailure(arg0_1) {
    return new Msg$2("RecordFailedToLoad", [arg0_1]);
  };
...
function saveRecord$1(handler) {
  var url = "/api/InTakeQueue/InTakeStatusChange";

  var msgOnSuccess = function msgOnSuccess(arg0) {
    return new Msg$2("RecordSaved", [arg0]);
  };

  var msgOnFailure = function msgOnFailure(arg0_1) {
    return new Msg$2("RecordFailedToSave", [arg0_1]);
  };

  return function (handler_1) {
    postUpdate(url, msgOnSuccess, msgOnFailure, handler, handler_1, {
      ReturnedEntityType: makeGeneric(Chessie.Result, {
        TSuccess: RenditionInTakeStatusChangeHelpers.RenditionInTakeStatusChange,
        TMessage: Interface("System.Collections.Generic.IEnumerable")
      }),
...
function InitQueryRequest$2(recordId) {
  return new InQueueById.QueryParam(recordId);
}
function Load$2(queryRequest) {
  return getRecord$2(queryRequest);
}
function Save$1(record) {
  return saveRecord$1(RenditionInTakeStatusChangeHelpers.ToRendition(record));
}

function ViewReadOnlyRenditionRequestBaseInfo(model) {
  return ofArray([ReactHelpers.Header("Loan Request Basic Info"), ReactHelpers.Col(ofArray([ReactHelpers.ReadOnlyField("Request status", model.RequestStatus), ReactHelpers.ReadOnlyField("Loan type", model.LoanType), ReactHelpers.ReadOnlyField("Amount requested", model.AmountRequested)])), ReactHelpers.Col(ofArray([ReactHelpers.ReadOnlyField("Loan purpose", model.LoanPurpose), ReactHelpers.ReadOnlyField("Specific purpose", model.SpecificPurpose), ReactHelpers.ReadOnlyField("Is one year financials required", model.IsOneYearFinancialsRequired)]))]);
}

function ViewReadOnly(model) {
  var tableData = toList(map$1(function (c) {
    return ofArray([c.CollateralReference, c.CollateralType, c.CollateralTypeName]);
  }, model));
  return ofArray([ReactHelpers.Header("Collateral Info"), ReactHelpers.CreateTable(ofArray(["Specific Description", "Collateral type", "Collateral type name"]), tableData)]);
}

function ViewReadOnly$1(models) {
  var tableData = toList(map$1(function (model) {
    return ofArray([model.AcctNumber, String(model.CurrentPrincipalBalance), String(model.CreditRiskCode), toString(model.BalanceAsOf).substr(0, 10)]);
  }, models));
  return ofArray([ReactHelpers.Header("Balances"), ReactHelpers.CreateTable(ofArray(["Account number", "Book+Available balance", "Credit risk code", "Balance as of"]), tableData)]);
}

function ViewReadOnly$2(model) {
  return ofArray([ReactHelpers.Col(ofArray([ReactHelpers.ReadOnlyField("Address street 1", model.AddressStreet1), ReactHelpers.ReadOnlyField("Address city", model.AddressCity)])), ReactHelpers.Col(ofArray([ReactHelpers.ReadOnlyField("Address state code", model.AddressStateCode), ReactHelpers.ReadOnlyField("Address zip code", model.AddressZipCode)]))]);
}

function View$3(model) {
  return ofArray([ReactHelpers.Header("Company Info"), ReactHelpers.Col(ofArray([ReactHelpers.ReadOnlyField("Tax id", model.TaxId), ReactHelpers.ReadOnlyField("Company type", model.CompanyType), ReactHelpers.ReadOnlyField("Gross annual revenue", model.GrossAnnualRevenue), ReactHelpers.ReadOnlyField("Registered name", model.RegisteredName), ReactHelpers.ReadOnlyField("Trade name", model.TradeName), ReactHelpers.ReadOnlyField("Business phone", model.BusinessPhone), ReactHelpers.ReadOnlyField("State code stablished", model.StateCodeStablished), ReactHelpers.ReadOnlyField("Loan industry", model.LoanIndustry), ReactHelpers.ReadOnlyField("Nature of business", model.NatureOfBusiness), ReactHelpers.ReadOnlyField("Legal status", model.LegalStatus), ReactHelpers.ReadOnlyField("Registration number", model.RegistrationNumber), ReactHelpers.ReadOnlyField("State filing url", model.StateFilingUrl)])), ReactHelpers.Col(ofArray([ReactHelpers.ReadOnlyField("Revenue more than one million", model.RevenueMoreThanOneMillion), ReactHelpers.ReadOnlyField("Has requested to apply jointly", model.HasRequestedToApplyJointly), ReactHelpers.ReadOnlyField("Date established", model.DateEstablished), ReactHelpers.ReadOnlyField("DDA collective balance", model.DDACollectiveBalance), ReactHelpers.ReadOnlyField("Is physical address same as mailing", model.IsPhysicalSameAsMailing)])), ReactHelpers.Header3("Physical Address"), ReactHelpers.Group(ViewReadOnly$2(model.PhysicalAddress)), ReactHelpers.Header3("Mailing Address"), ReactHelpers.Group(ViewReadOnly$2(model.MailingAddress))]);
}

function ViewReadOnly$4(model) {
  return ofArray([ReactHelpers.Col(ofArray([ReactHelpers.ReadOnlyField("Real estate primary residence", model.RealEstatePrimaryResidence), ReactHelpers.ReadOnlyField("Real estate second home", model.RealEstateSecondHome), ReactHelpers.ReadOnlyField("Vehicles", model.Vehicles), ReactHelpers.ReadOnlyField("Personal property", model.PersonalProperty), ReactHelpers.ReadOnlyField("Checking accounts", model.CheckingAccounts), ReactHelpers.ReadOnlyField("Savings accounts", model.SavingsAccounts), ReactHelpers.ReadOnlyField("Certificates of deposit", model.CertificatesOfDeposit), ReactHelpers.ReadOnlyField("Money market accounts", model.MoneyMarketAccounts), ReactHelpers.ReadOnlyField("Life insurance", model.LifeInsurance), ReactHelpers.ReadOnlyField("Other", model.Other), ReactHelpers.ReadOnlyField("Retirement accounts", model.RetirementAccounts), ReactHelpers.ReadOnlyField("Publicly traded stocks and bonds", model.PubliclyTradedStocksAndBonds)])), ReactHelpers.Col(ofArray([ReactHelpers.ReadOnlyField("Real estate rental and investment", model.RealEstateRentalAndInvestment), ReactHelpers.ReadOnlyField("Value of privately held companies", model.ValueOfPrivatelyHeldCompanies), ReactHelpers.ReadOnlyField("Mortgage loan primary residence", model.MortgageLoanPrimaryResidence), ReactHelpers.ReadOnlyField("Home equity loan primary residence", model.HomeEquityLoanPrimaryResidence), ReactHelpers.ReadOnlyField("Real estate loans second home", model.RealEstateLoansSecondHome), ReactHelpers.ReadOnlyField("Real estate loans rental investment", model.RealEstateLoansRentalInvestment), ReactHelpers.ReadOnlyField("Car loans", model.CarLoans), ReactHelpers.ReadOnlyField("Student loans", model.StudentLoans), ReactHelpers.ReadOnlyField("Credit card debt", model.CreditCardDebt), ReactHelpers.ReadOnlyField("Other debt", model.OtherDebt), ReactHelpers.ReadOnlyField("Assets total", model.AssetsTotal), ReactHelpers.ReadOnlyField("Liabilities total", model.LiabilitiesTotal), ReactHelpers.ReadOnlyField("Net worth", model.NetWorth)]))]);
}

function ViewReadOnly$5(model) {
  return ofArray([ReactHelpers.Col(ofArray([ReactHelpers.ReadOnlyField("Salary", model.Salary), ReactHelpers.ReadOnlyField("Bonusand commissions", model.BonusandCommissions), ReactHelpers.ReadOnlyField("Interestand dividends", model.InterestandDividends), ReactHelpers.ReadOnlyField("Recurring capital gains", model.RecurringCapitalGains)])), ReactHelpers.Col(ofArray([ReactHelpers.ReadOnlyField("Recurring real estate income", model.RecurringRealEstateIncome), ReactHelpers.ReadOnlyField("Recurring other income", model.RecurringOtherIncome), ReactHelpers.ReadOnlyField("Total annual income", model.TotalAnnualIncome), ReactHelpers.ReadOnlyField("Total monthly income", model.TotalMonthlyIncome)]))]);
}

function ViewReadOnly$3(model) {
  return ofArray([ReactHelpers.Header3(LightSwitchRenditionTypes.PersonNameRenditionHelpers.ToFullName(model.PersonName)), ReactHelpers.Group(ofArray([ReactHelpers.Col(ofArray([ReactHelpers.ReadOnlyField("Entity type", model.EntityType), ReactHelpers.ReadOnlyField("Tax id", model.TaxId), ReactHelpers.ReadOnlyField("Ownership percent", function () {
    var copyOfStruct = model.OwnershipPercent * 100;
    return String(copyOfStruct);
  }() + "%"), ReactHelpers.ReadOnlyField("Related since", model.RelatedSince), ReactHelpers.ReadOnlyField("ID type", model.IDType), ReactHelpers.ReadOnlyField("ID number", model.IDNumber), ReactHelpers.ReadOnlyField("Issue date", model.IssueDate), ReactHelpers.ReadOnlyField("Expiration date", model.ExpirationDate), ReactHelpers.ReadOnlyField("Issuer", model.Issuer), ReactHelpers.ReadOnlyField("Email address", model.EmailAddress), ReactHelpers.ReadOnlyField("Is primary contact", model.IsPrimaryContact)])), ReactHelpers.Col(ofArray([ReactHelpers.ReadOnlyField("Entity relationship", model.EntityRelationship), ReactHelpers.ReadOnlyField("Date of birth", model.DateOfBirth), ReactHelpers.ReadOnlyField("Business phone", model.BusinessPhone), ReactHelpers.ReadOnlyField("Has declared bankruptcy", model.HasDeclaredBankruptcy), ReactHelpers.ReadOnlyField("Details on bankruptcy", model.DetailsOnBankruptcy), ReactHelpers.ReadOnlyField("Has outstanding liens", model.HasOutstandingLiens), ReactHelpers.ReadOnlyField("Details on liens", model.DetailsOnLiens), ReactHelpers.ReadOnlyField("Is US citizen", model.IsUSCitizen), ReactHelpers.ReadOnlyField("Details on citizenship", model.DetailsOnCitizenship), ReactHelpers.ReadOnlyField("System ID in request", model.EntityIdInRequest)]))])), ReactHelpers.Header4("Address"), ReactHelpers.Group(ViewReadOnly$2(model.MainAddress)), ReactHelpers.Header4("Net Worth"), ReactHelpers.Group(ViewReadOnly$4(model.NetWorth)), ReactHelpers.Header4("Personal Income"), ReactHelpers.Group(ViewReadOnly$5(model.CombinedIncome))]);
}
function ViewReadOnlyList(models) {
  var txtData = function (list) {
    return map$$1(function (elements) {
      return ReactHelpers.Group(elements);
    }, list);
  }(function (list_1) {
    return map$$1(function (model) {
      return ViewReadOnly$3(model);
    }, list_1);
  }(toList(models)));

  return new List$1(ReactHelpers.Header("Owners and Guarantors"), txtData);
}
...
function viewReasons(model, msgSender) {
  var reasonCallback = function reasonCallback(idx) {
    return function (txtValue) {
      return new Msg$2("Reason", [[idx, txtValue]]);
    };
  };

  return react.createElement.apply(undefined, ["div", {
    className: "status-reasons"
  }].concat(_toConsumableArray$2(toList(mapIndexed$1(function (idx_1, r) {
    var l = "Reason " + function () {
      var copyOfStruct = idx_1 + 1;
      return String(copyOfStruct);
    }();

    return ReactHelpers.TextField(l, r, reasonCallback(idx_1), msgSender);
  }, model.Reasons)))));
}

function viewStatusEdit(statusChanged, model, msgSender) {
  var statusChoices = [[new LightSwitchRenditionTypes.RequestStatus("SubmittedByOfficer", []), "Submitted by Officer"], [new LightSwitchRenditionTypes.RequestStatus("Incomplete", []), "Incomplete"], [new LightSwitchRenditionTypes.RequestStatus("InProcess", []), "In Process"], [new LightSwitchRenditionTypes.RequestStatus("Denied", []), LightSwitchRenditionTypes.RequestStatusHelpers.Constants.DENY], [new LightSwitchRenditionTypes.RequestStatus("GrayAreaDenial", []), LightSwitchRenditionTypes.RequestStatusHelpers.Constants.GRYD], [new LightSwitchRenditionTypes.RequestStatus("GrayAreaMitigantReview", []), LightSwitchRenditionTypes.RequestStatusHelpers.Constants.GRYR], [new LightSwitchRenditionTypes.RequestStatus("ApprovedWaitingAcceptance", []), LightSwitchRenditionTypes.RequestStatusHelpers.Constants.APPR], [new LightSwitchRenditionTypes.RequestStatus("Completed", []), LightSwitchRenditionTypes.RequestStatusHelpers.Constants.CMPL]].map(function (tupledArg) {
    return [LightSwitchRenditionTypes.RequestStatusHelpers.ToRendition(tupledArg[0]), tupledArg[1]];
  });
  return react.createElement("div", {
    className: "col-md-4"
  }, react.createElement("h4", {}, "Request Status Change"), react.createElement("div", {}, ReactHelpers.DropDownFieldStr(statusChoices, function (arg0) {
    return new Msg$2("NewStatus", [arg0]);
  }, "New Status", LightSwitchRenditionTypes.RequestStatusHelpers.ToRendition(model.NewStatus), msgSender), viewReasons(model, msgSender), statusChanged ? react.createElement("button", {
    className: "btn btn-primary",
    onMouseUp: function () {
      var msg = new Msg$2("SaveRecord", []);
      return function (mouseEvt) {
        ReactHelpers.onBtnClick(msg, msgSender, mouseEvt);
      };
    }()
  }, "Save New Status") : react.createElement("div", {})));
}

function ReadonOnlyView(lonReq) {
  var headers = react.createElement("ul", {}, react.createElement("li", {}, react.createElement("a", {
    href: "#tabsBasicInfo"
  }, "Basic Info")), react.createElement("li", {}, react.createElement("a", {
    href: "#tabsCollateral"
  }, "Collateral")), react.createElement("li", {}, react.createElement("a", {
    href: "#tabsBalances"
  }, "Balances")), react.createElement("li", {}, react.createElement("a", {
    href: "#tabsCompany"
  }, "Company")), react.createElement("li", {}, react.createElement("a", {
    href: "#tabsRelatedEntities"
  }, "Owners/Guarantors")));
  var children = ofArray([react.createElement.apply(undefined, ["div", {
    id: "tabsBasicInfo"
  }].concat(_toConsumableArray$2(ViewReadOnlyRenditionRequestBaseInfo(lonReq.RequestBaseInfo)))), react.createElement.apply(undefined, ["div", {
    id: "tabsCollateral"
  }].concat(_toConsumableArray$2(ViewReadOnly(lonReq.Collateral)))), react.createElement.apply(undefined, ["div", {
    id: "tabsBalances"
  }].concat(_toConsumableArray$2(ViewReadOnly$1(lonReq.AggregatedBalacesInfo.CoreBalances)))), react.createElement.apply(undefined, ["div", {
    id: "tabsCompany"
  }].concat(_toConsumableArray$2(View$3(lonReq.RequestingCompany)))), react.createElement.apply(undefined, ["div", {
    id: "tabsRelatedEntities"
  }].concat(_toConsumableArray$2(ViewReadOnlyList(lonReq.RelatedEntities))))]);
  var tabs = React.createElement(EJ.Tab, {}, new List$1(headers, children));
  return react.createElement("div", {}, tabs);
}
function View$2(screen, msgSender) {
  var link = "\\\\csbfl-web1-test\\XpressLoanDocs\\" + String(screen.QueryModel.LrId);
  var backUrl = "/public/?screen=BriefsQueue";
  var canSave = screen.CanSave ? screen.QueryModel.RequestBaseInfo.RequestStatus !== LightSwitchRenditionTypes.RequestStatusHelpers.ToRendition(screen.EditModel.NewStatus) : false;
  return react.createElement("div", {}, viewStatusEdit(canSave, screen.EditModel, msgSender), react.createElement("div", {
    className: "request-view row"
  }, react.createElement("a", {
    href: link
  }, link), ReadonOnlyView(screen.QueryModel)), react.createElement("a", {
...
function update$2(appMsg, screen) {
  if (appMsg.Case === "RecordLoaded") {
    if (appMsg.Fields[0].Case === "Bad") {
      return [function () {
        var CurrentErrors = appMsg.Fields[0].Fields[0].head;
        return new ScreenType$2(screen.QueryModel, screen.EditModel, CurrentErrors, screen.CanSave);
      }(), new List$1()];
    } else {
      var newChild = RenditionInTakeStatusChangeHelpers.FromRendition(function () {
        var LrId = String(appMsg.Fields[0].Fields[0].LrId);
        var NewStatus = appMsg.Fields[0].Fields[0].RequestBaseInfo.RequestStatus;
        var Username = "Me";
        var Reasons = ofArray([""]);
        return new RenditionInTakeStatusChangeHelpers.RenditionInTakeStatusChange(-1, LrId, NewStatus, Username, Reasons);
      }());
      return [function () {
        var CanSave = true;
        return new ScreenType$2(appMsg.Fields[0].Fields[0], newChild, screen.CurrentErrors, CanSave);
      }(), new List$1()];
    }
  } else if (appMsg.Case === "RecordFailedToLoad") {
    return [function () {
      var CurrentErrors_1 = ofArray([appMsg.Fields[0]]);
      var CanSave_1 = false;
      return new ScreenType$2(screen.QueryModel, screen.EditModel, CurrentErrors_1, CanSave_1);
    }(), new List$1()];
  } else if (appMsg.Case === "NewStatus") {
    var newChild_1 = void 0;
    var NewStatus_1 = LightSwitchRenditionTypes.RequestStatusHelpers.FromRendition(appMsg.Fields[0]);
    newChild_1 = new InTakeStatusChange(screen.EditModel.LrId, NewStatus_1, screen.EditModel.Username, screen.EditModel.Reasons);
    return [new ScreenType$2(screen.QueryModel, newChild_1, screen.CurrentErrors, screen.CanSave), new List$1()];
  } else if (appMsg.Case === "Reason") {
    var newVal = appMsg.Fields[0][1];
    var idx = appMsg.Fields[0][0];
    var newChild_2 = InTakeStatusChangeHelpers.UpdateReason(screen.EditModel, idx, newVal);
    return [new ScreenType$2(screen.QueryModel, newChild_2, screen.CurrentErrors, screen.CanSave), new List$1()];
  } else if (appMsg.Case === "SaveRecord") {
    return [function () {
      var CanSave_2 = false;
      return new ScreenType$2(screen.QueryModel, screen.EditModel, screen.CurrentErrors, CanSave_2);
    }(), ofArray([Save$1(screen.EditModel)])];
  } else if (appMsg.Case === "RecordSaved") {
    if (appMsg.Fields[0].Case === "Bad") {
      return [function () {
        var CurrentErrors_2 = appMsg.Fields[0].Fields[0].head;
        return new ScreenType$2(screen.QueryModel, screen.EditModel, CurrentErrors_2, screen.CanSave);
      }(), new List$1()];
    } else {
      window.location.href = "/public/?screen=BriefsQueue";
      return [function () {
        var CanSave_3 = true;
        return new ScreenType$2(screen.QueryModel, screen.EditModel, screen.CurrentErrors, CanSave_3);
      }(), new List$1()];
    }
  } else if (appMsg.Case === "RecordFailedToSave") {
    return [function () {
      var CurrentErrors_3 = ofArray([appMsg.Fields[0]]);
      var CanSave_4 = true;
      return new ScreenType$2(screen.QueryModel, screen.EditModel, CurrentErrors_3, CanSave_4);
    }(), new List$1()];
  } else {
    return [screen, ofArray([Load$2(appMsg.Fields[0])])];
  }
}
var emptyModel$2 = EmptyScreen$2;
function init$2(paramQry) {
  return [emptyModel$2, ofArray([Load$2(paramQry)])];
}

function getParamValue$2(qryParams, paramName) {
...
function RunScreen$2(divId, qryParams) {
  var recordId = getParamValue$2(qryParams, "recordId");

  if (recordId == null) {} else {
    var recordIdInt = ConversionHelpers.tryParseInt(recordId);

    if (recordIdInt == null) {} else {
      var paramQry = InitQueryRequest$2(recordIdInt);
      ProgramModule.run(function (program) {
        return withReact(divId, program);
      }(ProgramModule.mkProgram(function () {
        return init$2(paramQry, null);
      }, function (appMsg) {
        return function (screen) {
          return update$2(appMsg, screen);
        };
      }, function (screen_1) {
        return function (msgSender) {
          return View$2(screen_1, msgSender);
        };
      })));
    }
  }
...
function OnInit() {
  ...
  switch (screenName) {
    case "BriefsQueue":
      RunScreen("screenPlaceholder", urlParams);
      break;

    case "UpdateCollateralDoc":
      RunScreen$1("screenPlaceholder", urlParams);
      break;

    case "EditQueuedRequest":
      RunScreen$2("screenPlaceholder", urlParams);
      break;
